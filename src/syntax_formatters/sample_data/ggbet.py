<<<<<<< HEAD
bets =  {'100 thieves - gen.g': {'100 thieves handicap +1.5 maps': {'2.17': 'ggbet'},
                         '100 thieves total over 31.5': {'1.38': 'ggbet'},
                         '100 thieves total over 33.5': {'1.7': 'ggbet'},
                         '100 thieves total over 37.5': {'2.09': 'ggbet'},
                         '100 thieves total over 49.5': {'2.63': 'ggbet'},
                         '100 thieves total under 31.5': {'2.9': 'ggbet'},
                         '100 thieves total under 33.5': {'2.08': 'ggbet'},
                         '100 thieves total under 37.5': {'1.69': 'ggbet'},
                         '100 thieves total under 49.5': {'1.45': 'ggbet'},
                         '100 thieves will win': {'3.03': 'ggbet'},
                         '2-nd map: 100 thieves total over 11.5': {'1.38': 'ggbet'},
                         '2-nd map: 100 thieves total over 12.5': {'1.52': 'ggbet'},
                         '2-nd map: 100 thieves total over 13.5': {'1.7': 'ggbet'},
                         '2-nd map: 100 thieves total over 14.5': {'1.92': 'ggbet'},
                         '2-nd map: 100 thieves total over 15.5': {'2.66': 'ggbet'},
                         '2-nd map: 100 thieves total under 11.5': {'2.9': 'ggbet'},
                         '2-nd map: 100 thieves total under 12.5': {'2.43': 'ggbet'},
                         '2-nd map: 100 thieves total under 13.5': {'2.08': 'ggbet'},
                         '2-nd map: 100 thieves total under 14.5': {'1.82': 'ggbet'},
                         '2-nd map: 100 thieves total under 15.5': {'1.44': 'ggbet'},
                         '2-nd map: 100 thieves will win': {'2.05': 'ggbet'},
                         '2-nd map: 100 thieves will win round 16': {'1.81': 'ggbet'},
                         '2-nd map: correct score 10-16': {'9.39': 'ggbet'},
                         '2-nd map: correct score 11-16': {'9.06': 'ggbet'},
                         '2-nd map: correct score 12-16': {'8.92': 'ggbet'},
                         '2-nd map: correct score 13-16': {'8.95': 'ggbet'},
                         '2-nd map: correct score 14-16': {'9.11': 'ggbet'},
                         '2-nd map: correct score 16-10': {'13.79': 'ggbet'},
                         '2-nd map: correct score 16-11': {'10.37': 'ggbet'},
                         '2-nd map: correct score 16-12': {'9.34': 'ggbet'},
                         '2-nd map: correct score 16-13': {'8.66': 'ggbet'},
                         '2-nd map: correct score 16-14': {'8.29': 'ggbet'},
                         '2-nd map: correct score 16-7': {'100': 'ggbet'},
                         '2-nd map: correct score 16-8': {'32.89': 'ggbet'},
                         '2-nd map: correct score 16-9': {'18.87': 'ggbet'},
                         '2-nd map: correct score 4-16': {'73.88': 'ggbet'},
                         '2-nd map: correct score 5-16': {'28.41': 'ggbet'},
                         '2-nd map: correct score 6-16': {'18.15': 'ggbet'},
                         '2-nd map: correct score 7-16': {'14.04': 'ggbet'},
                         '2-nd map: correct score 8-16': {'11.9': 'ggbet'},
                         '2-nd map: correct score 9-16': {'9.95': 'ggbet'},
                         '2-nd map: ct total  over 10.5': {'1.33': 'ggbet'},
                         '2-nd map: ct total  over 11.5': {'1.87': 'ggbet'},
                         '2-nd map: ct total  under 10.5': {'3.14': 'ggbet'},
                         '2-nd map: ct total  under 11.5': {'1.87': 'ggbet'},
                         '2-nd map: first half correct score 4-11': {'8.38': 'ggbet'},
                         '2-nd map: first half correct score 5-10': {'3.83': 'ggbet'},
                         '2-nd map: first half correct score 6-9': {'2.92': 'ggbet'},
                         '2-nd map: first half correct score 7-8': {'3.21': 'ggbet'},
                         '2-nd map: first half correct score 8-7': {'6.37': 'ggbet'},
                         '2-nd map: gen.g total over 14.5': {'1.47': 'ggbet'},
                         '2-nd map: gen.g total over 15.5': {'1.87': 'ggbet'},
                         '2-nd map: gen.g total under 14.5': {'2.57': 'ggbet'},
                         '2-nd map: gen.g total under 15.5': {'1.87': 'ggbet'},
                         '2-nd map: gen.g will win': {'1.72': 'ggbet'},
                         '2-nd map: gen.g will win round 16': {'1.93': 'ggbet'},
                         '2-nd map: handicap 100 thieves +1.5': {'1.92': 'ggbet'},
                         '2-nd map: handicap 100 thieves +2.5': {'1.7': 'ggbet'},
                         '2-nd map: handicap 100 thieves +3.5': {'1.52': 'ggbet'},
                         '2-nd map: handicap 100 thieves +4.5': {'1.38': 'ggbet'},
                         '2-nd map: handicap 100 thieves -1.5': {'2.66': 'ggbet'},
                         '2-nd map: handicap gen.g +1.5': {'1.44': 'ggbet'},
                         '2-nd map: handicap gen.g -1.5': {'1.82': 'ggbet'},
                         '2-nd map: handicap gen.g -2.5': {'2.08': 'ggbet'},
                         '2-nd map: handicap gen.g -3.5': {'2.43': 'ggbet'},
                         '2-nd map: handicap gen.g -4.5': {'2.9': 'ggbet'},
                         '2-nd map: race to  rounds 100 thieves 11': {'3.09': 'ggbet'},
                         '2-nd map: race to  rounds 100 thieves 12': {'2.77': 'ggbet'},
                         '2-nd map: race to  rounds gen.g 11': {'1.34': 'ggbet'},
                         '2-nd map: race to  rounds gen.g 12': {'1.41': 'ggbet'},
                         '2-nd map: round 100 thieves 15  will win': {'1.77': 'ggbet'},
                         '2-nd map: round 100 thieves 17  will win': {'1.73': 'ggbet'},
                         '2-nd map: round gen.g 15  will win': {'1.98': 'ggbet'},
                         '2-nd map: round gen.g 17  will win': {'2.03': 'ggbet'},
                         '2-nd map: terrorist total over 14.5': {'1.39': 'ggbet'},
                         '2-nd map: terrorist total over 15.5': {'1.74': 'ggbet'},
                         '2-nd map: terrorist total over 17.5': {'3.26': 'ggbet'},
                         '2-nd map: terrorist total under 14.5': {'2.85': 'ggbet'},
                         '2-nd map: terrorist total under 15.5': {'2.02': 'ggbet'},
                         '2-nd map: terrorist total under 17.5': {'1.31': 'ggbet'},
                         '2-nd map: total over 26.5': {'1.43': 'ggbet'},
                         '2-nd map: total over 27.5': {'1.72': 'ggbet'},
                         '2-nd map: total over 28.5': {'2.23': 'ggbet'},
                         '2-nd map: total over 29.5': {'3.26': 'ggbet'},
                         '2-nd map: total under 26.5': {'2.7': 'ggbet'},
                         '2-nd map: total under 27.5': {'2.05': 'ggbet'},
                         '2-nd map: total under 28.5': {'1.61': 'ggbet'},
                         '2-nd map: total under 29.5': {'1.31': 'ggbet'},
                         '2-nd map: will there be overtime no': {'1.13': 'ggbet'},
                         '2-nd map: will there be overtime yes': {'5.4': 'ggbet'},
                         '2nd map first half - handicap 100 thieves +3.5': {'1.31': 'ggbet'},
                         '2nd map first half - handicap gen.g -3.5': {'3.26': 'ggbet'},
                         '2nd map second half - 1x2 100 thieves': {'1.67': 'ggbet'},
                         '2nd map second half - 1x2 draw': {'10.54': 'ggbet'},
                         '2nd map second half - 1x2 gen.g': {'2.37': 'ggbet'},
                         '2nd map second half - handicap 100 thieves +1.5': {'1.36': 'ggbet'},
                         '2nd map second half - handicap 100 thieves -0.5': {'1.67': 'ggbet'},
                         '2nd map second half - handicap 100 thieves -2.5': {'2.16': 'ggbet'},
                         '2nd map second half - handicap 100 thieves -4.5': {'3.14': 'ggbet'},
                         '2nd map second half - handicap gen.g +0.5': {'2.12': 'ggbet'},
                         '2nd map second half - handicap gen.g +2.5': {'1.65': 'ggbet'},
                         '2nd map second half - handicap gen.g +4.5': {'1.33': 'ggbet'},
                         '2nd map second half - handicap gen.g -1.5': {'2.99': 'ggbet'},
                         'correct score 0-2': {'1.64': 'ggbet'},
                         'correct score 1-2': {'5.84': 'ggbet'},
                         'correct score 2-1': {'3.04': 'ggbet'},
                         'gen.g handicap -1.5 maps': {'1.64': 'ggbet'},
                         'gen.g total over 38.5': {'1.99': 'ggbet'},
                         'gen.g total over 42.5': {'2.51': 'ggbet'},
                         'gen.g total under 38.5': {'1.76': 'ggbet'},
                         'gen.g total under 42.5': {'1.49': 'ggbet'},
                         'gen.g will win': {'1.36': 'ggbet'},
                         'handicap 100 thieves +2.5': {'2.57': 'ggbet'},
                         'handicap 100 thieves +4.5': {'1.94': 'ggbet'},
                         'handicap 100 thieves +5.5': {'1.63': 'ggbet'},
                         'handicap 100 thieves +6.5': {'1.42': 'ggbet'},
                         'handicap 100 thieves -2.5': {'3.09': 'ggbet'},
                         'handicap gen.g +2.5': {'1.34': 'ggbet'},
                         'handicap gen.g -2.5': {'1.47': 'ggbet'},
                         'handicap gen.g -4.5': {'1.8': 'ggbet'},
                         'handicap gen.g -5.5': {'2.19': 'ggbet'},
                         'handicap gen.g -6.5': {'2.73': 'ggbet'},
                         'odd/even maps even': {'1.68': 'ggbet'},
                         'odd/even maps odd': {'2.11': 'ggbet'},
                         'total maps over 2.5': {'2.11': 'ggbet'},
                         'total maps under 2.5': {'1.68': 'ggbet'},
                         'total over 69.5': {'1.38': 'ggbet'},
                         'total over 70.5': {'1.52': 'ggbet'},
                         'total over 71.5': {'1.7': 'ggbet'},
                         'total over 72.5': {'1.92': 'ggbet'},
                         'total over 84.5': {'2.14': 'ggbet'},
                         'total over 92.5': {'2.45': 'ggbet'},
                         'total over 95.5': {'3.04': 'ggbet'},
                         'total under 69.5': {'2.9': 'ggbet'},
                         'total under 70.5': {'2.43': 'ggbet'},
                         'total under 71.5': {'2.08': 'ggbet'},
                         'total under 72.5': {'1.82': 'ggbet'},
                         'total under 84.5': {'1.66': 'ggbet'},
                         'total under 92.5': {'1.51': 'ggbet'},
                         'total under 95.5': {'1.35': 'ggbet'}},
 'adaptation - blink': {'1-st map: adaptation will win': {'1.67': 'ggbet'},
                        '1-st map: blink will win': {'2.12': 'ggbet'},
                        'adaptation will win': {'1.69': 'ggbet'},
                        'blink will win': {'2.11': 'ggbet'}},
 'ago - nordavind': {'1-st map: ago total over 10.5': {'1.33': 'ggbet'},
                     '1-st map: ago total over 11.5': {'1.45': 'ggbet'},
                     '1-st map: ago total over 12.5': {'1.59': 'ggbet'},
                     '1-st map: ago total over 13.5': {'1.77': 'ggbet'},
                     '1-st map: ago total over 14.5': {'1.99': 'ggbet'},
                     '1-st map: ago total over 15.5': {'2.57': 'ggbet'},
                     '1-st map: ago total over 9.5': {'1.23': 'ggbet'},
                     '1-st map: ago total under 10.5': {'3.14': 'ggbet'},
                     '1-st map: ago total under 11.5': {'2.63': 'ggbet'},
                     '1-st map: ago total under 12.5': {'2.27': 'ggbet'},
                     '1-st map: ago total under 13.5': {'1.98': 'ggbet'},
                     '1-st map: ago total under 14.5': {'1.76': 'ggbet'},
                     '1-st map: ago total under 15.5': {'1.47': 'ggbet'},
                     '1-st map: ago total under 9.5': {'3.89': 'ggbet'},
                     '1-st map: ago will win': {'2.27': 'ggbet'},
                     '1-st map: ago will win round 1': {'1.91': 'ggbet'},
                     '1-st map: correct score 10t-e': {'13.24': 'ggbet'},
                     '1-st map: correct score 11t-e': {'12.31': 'ggbet'},
                     '1-st map: correct score 12t-e': {'11.67': 'ggbet'},
                     '1-st map: correct score 13t-e': {'10.37': 'ggbet'},
                     '1-st map: correct score 14t-e': {'10.21': 'ggbet'},
                     '1-st map: correct score 16t-e': {'9.49': 'ggbet'},
                     '1-st map: correct score 1t-e': {'10.08': 'ggbet'},
                     '1-st map: correct score 2t-e': {'100': 'ggbet'},
                     '1-st map: correct score 3t-e': {'90.67': 'ggbet'},
                     '1-st map: correct score 4t-e': {'50.88': 'ggbet'},
                     '1-st map: correct score 5t-e': {'33.32': 'ggbet'},
                     '1-st map: correct score 6t-e': {'24.47': 'ggbet'},
                     '1-st map: correct score 7t-e': {'19.53': 'ggbet'},
                     '1-st map: correct score 8t-e': {'16.53': 'ggbet'},
                     '1-st map: correct score 9t-e': {'14.57': 'ggbet'},
                     ...
                     '1-st map: handicap ago +1.5': {'1.99': 'ggbet'},
                     '1-st map: handicap ago +2.5': {'1.77': 'ggbet'},
                     '1-st map: handicap ago +3.5': {'1.59': 'ggbet'},
                     '1-st map: handicap ago +4.5': {'1.45': 'ggbet'},
                     '1-st map: handicap ago +5.5': {'1.33': 'ggbet'},
                     '1-st map: handicap ago +6.5': {'1.23': 'ggbet'},
                     '1-st map: handicap ago -1.5': {'2.57': 'ggbet'},
                     '1-st map: handicap ago -2.5': {'2.94': 'ggbet'},
                     '1-st map: handicap ago -3.5': {'3.46': 'ggbet'},
                     '1-st map: handicap ago -4.5': {'4.11': 'ggbet'},
                     '1-st map: handicap nordavind +1.5': {'1.47': 'ggbet'},
                     '1-st map: handicap nordavind +2.5': {'1.37': 'ggbet'},
                     '1-st map: handicap nordavind +3.5': {'1.28': 'ggbet'},
                     '1-st map: handicap nordavind +4.5': {'1.21': 'ggbet'},
                     '1-st map: handicap nordavind -1.5': {'1.76': 'ggbet'},
                     '1-st map: handicap nordavind -2.5': {'1.98': 'ggbet'},
                     '1-st map: handicap nordavind -3.5': {'2.27': 'ggbet'},
                     '1-st map: handicap nordavind -4.5': {'2.63': 'ggbet'},
                     '1-st map: handicap nordavind -5.5': {'3.14': 'ggbet'},
                     '1-st map: handicap nordavind -6.5': {'3.89': 'ggbet'},
                     '1-st map: nordavind total over 11.5': {'1.21': 'ggbet'},
                     '1-st map: nordavind total over 13.5': {'1.37': 'ggbet'},
                     '1-st map: nordavind total over 14.5': {'1.47': 'ggbet'},
                     '1-st map: nordavind total over 15.5': {'1.76': 'ggbet'},
                     '1-st map: nordavind total under 11.5': {'4.11': 'ggbet'},
                     '1-st map: nordavind total under 13.5': {'2.94': 'ggbet'},
                     '1-st map: nordavind total under 14.5': {'2.57': 'ggbet'},
                     '1-st map: nordavind total under 15.5': {'1.99': 'ggbet'},
                     '1-st map: nordavind will win': {'1.59': 'ggbet'},
                     '1-st map: nordavind will win round 1': {'1.83': 'ggbet'},
                     ...
                     '1-st map: total over 25.5': {'1.38': 'ggbet'},
                     '1-st map: total over 26.5': {'1.59': 'ggbet'},
                     '1-st map: total over 27.5': {'1.91': 'ggbet'},
                     '1-st map: total over 28.5': {'2.43': 'ggbet'},
                     '1-st map: total over 29.5': {'3.39': 'ggbet'},
                     '1-st map: total under 24.5': {'3.89': 'ggbet'},
                     '1-st map: total under 25.5': {'2.9': 'ggbet'},
                     '1-st map: total under 26.5': {'2.27': 'ggbet'},
                     '1-st map: total under 27.5': {'1.83': 'ggbet'},
                     '1-st map: total under 28.5': {'1.52': 'ggbet'},
                     '1-st map: total under 29.5': {'1.29': 'ggbet'},
                     'ago will win': {'2.27': 'ggbet'},
                     'nordavind will win': {'1.6': 'ggbet'}},
 'ahq - asking questions': {'1-st map: ahq will win': {'1.78': 'ggbet'},
                            '1-st map: asking questions will win': {'1.97': 'ggbet'},
                            '2-nd map: ahq will win': {'1.78': 'ggbet'},
                            '2-nd map: asking questions will win': {'1.97': 'ggbet'},
                            'ahq will win': {'1.76': 'ggbet'},
                            'asking questions will win': {'2.01': 'ggbet'}},
 'aim4r - w2c': {'1-st map: aim4r will win': {'2.31': 'ggbet'},
 ...
 'apeks - nemiga': {'1-st map: apeks will win': {'2.85': 'ggbet'},
                    '1-st map: apeks will win round 1': {'1.96': 'ggbet'},
                    '1-st map: handicap apeks +2.5': {'2.11': 'ggbet'},
                    '1-st map: handicap apeks +3.5': {'1.87': 'ggbet'},
                    '1-st map: handicap apeks +4.5': {'1.67': 'ggbet'},
                    '1-st map: handicap nemiga -2.5': {'1.68': 'ggbet'},
                    '1-st map: handicap nemiga -3.5': {'1.87': 'ggbet'},
                    '1-st map: handicap nemiga -4.5': {'2.12': 'ggbet'},
                    '1-st map: nemiga will win': {'1.39': 'ggbet'},
                    '1-st map: nemiga will win round 1': {'1.79': 'ggbet'},
                    '1-st map: total over 25.5': {'1.61': 'ggbet'},
                    '1-st map: total over 26.5': {'1.9': 'ggbet'},
                    '1-st map: total under 25.5': {'2.23': 'ggbet'},
                    '1-st map: total under 26.5': {'1.84': 'ggbet'},
                    '2-nd map: apeks will win': {'2.9': 'ggbet'},
                    '2-nd map: apeks will win round 1': {'1.96': 'ggbet'},
                    '2-nd map: handicap apeks +2.5': {'2.03': 'ggbet'},
                    '2-nd map: handicap apeks +3.5': {'1.81': 'ggbet'},
                    '2-nd map: handicap apeks +4.5': {'1.63': 'ggbet'},
                    '2-nd map: handicap nemiga -2.5': {'1.73': 'ggbet'},
                    '2-nd map: handicap nemiga -3.5': {'1.93': 'ggbet'},
                    '2-nd map: handicap nemiga -4.5': {'2.19': 'ggbet'},
                    '2-nd map: nemiga will win': {'1.38': 'ggbet'},
                    '2-nd map: nemiga will win round 1': {'1.79': 'ggbet'},
                    '2-nd map: total over 25.5': {'1.62': 'ggbet'},
                    '2-nd map: total over 26.5': {'1.91': 'ggbet'},
                    '2-nd map: total under 25.5': {'2.21': 'ggbet'},
                    '2-nd map: total under 26.5': {'1.83': 'ggbet'},
                    'apeks handicap +1.5 maps': {'1.85': 'ggbet'},
                    'apeks handicap -1.5 maps': {'6.21': 'ggbet'},
                    'apeks will win': {'3.45': 'ggbet'},
                    'correct score 0-2': {'1.89': 'ggbet'},
                    'correct score 1-2': {'3.51': 'ggbet'},
                    'correct score 2-0': {'6.25': 'ggbet'},
                    'correct score 2-1': {'5.85': 'ggbet'},
                    'nemiga handicap +1.5 maps': {'1.1': 'ggbet'},
                    'nemiga handicap -1.5 maps': {'1.89': 'ggbet'},
                    'nemiga will win': {'1.29': 'ggbet'},
                    'odd/even maps even': {'1.54': 'ggbet'},
                    'odd/even maps odd': {'2.38': 'ggbet'},
                    'total maps over 2.5': {'2.38': 'ggbet'},
                    'total maps under 2.5': {'1.54': 'ggbet'}},
 'avant - paradox': {'1-st map: avant will win': {'1.35': 'ggbet'},
                     '1-st map: avant will win round 1': {'1.78': 'ggbet'},
                     '1-st map: handicap avant -1.5': {'1.46': 'ggbet'},
                     '1-st map: handicap avant -2.5': {'1.59': 'ggbet'},
                     '1-st map: handicap avant -3.5': {'1.76': 'ggbet'},
                     '1-st map: handicap avant -4.5': {'1.98': 'ggbet'},
                     '1-st map: handicap avant -5.5': {'2.29': 'ggbet'},
                     '1-st map: handicap avant -6.5': {'2.7': 'ggbet'},
                     '1-st map: handicap avant -7.5': {'3.26': 'ggbet'},
                     '1-st map: handicap paradox +1.5': {'2.6': 'ggbet'},
                     '1-st map: handicap paradox +2.5': {'2.27': 'ggbet'},
                     '1-st map: handicap paradox +3.5': {'1.99': 'ggbet'},
                     '1-st map: handicap paradox +4.5': {'1.77': 'ggbet'},
                     '1-st map: handicap paradox +5.5': {'1.58': 'ggbet'},
                     '1-st map: handicap paradox +6.5': {'1.43': 'ggbet'},
                     '1-st map: handicap paradox +7.5': {'1.31': 'ggbet'},
                     '1-st map: paradox will win': {'3.04': 'ggbet'},
                     '1-st map: paradox will win round 1': {'1.97': 'ggbet'},
                     '1-st map: total over 24.5': {'1.42': 'ggbet'},
                     ...
                     '1-st map: total under 24.5': {'2.73': 'ggbet'},
                     ...
                     '2-nd map: avant will win': {'1.35': 'ggbet'},
                     '2-nd map: avant will win round 1': {'1.78': 'ggbet'},
                     '2-nd map: handicap avant -1.5': {'1.46': 'ggbet'},
                     '2-nd map: handicap avant -2.5': {'1.58': 'ggbet'},
                     '2-nd map: handicap avant -3.5': {'1.75': 'ggbet'},
                     '2-nd map: handicap avant -4.5': {'1.97': 'ggbet'},
                     '2-nd map: handicap avant -5.5': {'2.27': 'ggbet'},
                     '2-nd map: handicap avant -6.5': {'2.66': 'ggbet'},
                     '2-nd map: handicap avant -7.5': {'3.26': 'ggbet'},
                     '2-nd map: handicap paradox +1.5': {'2.6': 'ggbet'},
                     '2-nd map: handicap paradox +2.5': {'2.29': 'ggbet'},
                     '2-nd map: handicap paradox +3.5': {'2.01': 'ggbet'},
                     '2-nd map: handicap paradox +4.5': {'1.78': 'ggbet'},
                     '2-nd map: handicap paradox +5.5': {'1.59': 'ggbet'},
                     '2-nd map: handicap paradox +6.5': {'1.44': 'ggbet'},
                     '2-nd map: handicap paradox +7.5': {'1.31': 'ggbet'},
                     '2-nd map: paradox will win': {'3.04': 'ggbet'},
                     '2-nd map: paradox will win round 1': {'1.97': 'ggbet'},
                     '2-nd map: total over 24.5': {'1.43': 'ggbet'},
                     '2-nd map: total over 25.5': {'1.64': 'ggbet'},
                     '2-nd map: total over 26.5': {'1.94': 'ggbet'},
                     '2-nd map: total over 27.5': {'2.4': 'ggbet'},
                     '2-nd map: total over 28.5': {'3.14': 'ggbet'},
                     '2-nd map: total under 24.5': {'2.7': 'ggbet'},
                     '2-nd map: total under 25.5': {'2.17': 'ggbet'},
                     '2-nd map: total under 26.5': {'1.8': 'ggbet'},
                     '2-nd map: total under 27.5': {'1.53': 'ggbet'},
                     '2-nd map: total under 28.5': {'1.33': 'ggbet'},
                     'avant handicap +1.5 maps': {'1.08': 'ggbet'},
                     'avant handicap -1.5 maps': {'1.8': 'ggbet'},
                     'avant will win': {'1.25': 'ggbet'},
                     'correct score 0-2': {'6.83': 'ggbet'},
                     'correct score 1-2': {'6.25': 'ggbet'},
                     'correct score 2-0': {'1.8': 'ggbet'},
                     'correct score 2-1': {'3.55': 'ggbet'},
                     'odd/even maps even': {'1.51': 'ggbet'},
                     'odd/even maps odd': {'2.45': 'ggbet'},
                     'paradox handicap +1.5 maps': {'1.94': 'ggbet'},
                     'paradox handicap -1.5 maps': {'6.94': 'ggbet'},
                     'paradox will win': {'3.77': 'ggbet'},
                     'total maps over 2.5': {'2.45': 'ggbet'},
                     'total maps under 2.5': {'1.51': 'ggbet'}},
 'big - vitality': {'1-st map: big total over 10.5': {'1.21': 'ggbet'},
                    '1-st map: big total over 11.5': {'1.29': 'ggbet'},
                    '1-st map: big total over 12.5': {'1.38': 'ggbet'},
                    '1-st map: big total over 13.5': {'1.49': 'ggbet'},
                    '1-st map: big total over 14.5': {'1.63': 'ggbet'},
                    '1-st map: big total over 15.5': {'2.01': 'ggbet'},
                    '1-st map: big total under 10.5': {'4.11': 'ggbet'},
                    '1-st map: big total under 11.5': {'3.39': 'ggbet'},
                    '1-st map: big total under 12.5': {'2.9': 'ggbet'},
                    '1-st map: big total under 13.5': {'2.51': 'ggbet'},
                    '1-st map: big total under 14.5': {'2.19': 'ggbet'},
                    '1-st map: big total under 15.5': {'1.75': 'ggbet'},
                    '1-st map: big will win': {'1.79': 'ggbet'},
                    '1-st map: big will win round 1': {'1.86': 'ggbet'},
                    '1-st map: correct score 10t-e': {'10.39': 'ggbet'},
                    '1-st map: correct score 11t-e': {'10.05': 'ggbet'},
                    '1-st map: correct score 12t-e': {'9.84': 'ggbet'},
                    '1-st map: correct score 13t-e': {'9.75': 'ggbet'},
                    '1-st map: correct score 14t-e': {'9.77': 'ggbet'},
                    '1-st map: correct score 16t-e': {'9.9': 'ggbet'},
                    '1-st map: correct score 1t-e': {'100': 'ggbet'},
                    '1-st map: correct score 2t-e': {'86.99': 'ggbet'},
                    '1-st map: correct score 3t-e': {'46.03': 'ggbet'},
                    '1-st map: correct score 4t-e': {'29.57': 'ggbet'},
                    '1-st map: correct score 5t-e': {'21.71': 'ggbet'},
                    '1-st map: correct score 6t-e': {'17.43': 'ggbet'},
                    '1-st map: correct score 7t-e': {'14.86': 'ggbet'},
                    '1-st map: correct score 8t-e': {'13.19': 'ggbet'},
                    '1-st map: correct score 9t-e': {'12.06': 'ggbet'},
                    ...
                    '1-st map: first half correct score 1h-t': {'80.96': 'ggbet'},
                    '1-st map: first half correct score 2h-t': {'27.35': 'ggbet'},
                    '1-st map: first half correct score 3h-t': {'14.61': 'ggbet'},
                    '1-st map: first half correct score 4h-t': {'9.25': 'ggbet'},
                    '1-st map: first half correct score 5h-t': {'6.98': 'ggbet'},
                    '1-st map: first half correct score h-t': {'5.86': 'ggbet'},
                    '1-st map: handicap big +1.5': {'1.63': 'ggbet'},
                    '1-st map: handicap big +2.5': {'1.49': 'ggbet'},
                    '1-st map: handicap big +3.5': {'1.38': 'ggbet'},
                    '1-st map: handicap big +4.5': {'1.29': 'ggbet'},
                    '1-st map: handicap big +5.5': {'1.21': 'ggbet'},
                    '1-st map: handicap big -1.5': {'2.01': 'ggbet'},
                    '1-st map: handicap big -2.5': {'2.27': 'ggbet'},
                    '1-st map: handicap big -3.5': {'2.6': 'ggbet'},
                    '1-st map: handicap big -4.5': {'3.04': 'ggbet'},
                    '1-st map: handicap big -5.5': {'3.7': 'ggbet'},
                    '1-st map: handicap vitality +1.5': {'1.75': 'ggbet'},
                    '1-st map: handicap vitality +2.5': {'1.59': 'ggbet'},
                    '1-st map: handicap vitality +3.5': {'1.46': 'ggbet'},
                    '1-st map: handicap vitality +4.5': {'1.35': 'ggbet'},
                    '1-st map: handicap vitality +5.5': {'1.25': 'ggbet'},
                    '1-st map: handicap vitality -1.5': {'2.19': 'ggbet'},
                    '1-st map: handicap vitality -2.5': {'2.51': 'ggbet'},
                    '1-st map: handicap vitality -3.5': {'2.9': 'ggbet'},
                    '1-st map: handicap vitality -4.5': {'3.39': 'ggbet'},
                    '1-st map: handicap vitality -5.5': {'4.11': 'ggbet'},
                    '1-st map: race to  rounds big 12': {'1.81': 'ggbet'},
                    '1-st map: race to  rounds big 3': {'1.84': 'ggbet'},
                    '1-st map: race to  rounds big 6': {'1.82': 'ggbet'},
                    '1-st map: race to  rounds big 9': {'1.82': 'ggbet'},
                    '1-st map: race to  rounds vitality 12': {'1.93': 'ggbet'},
                    '1-st map: race to  rounds vitality 3': {'1.9': 'ggbet'},
                    '1-st map: race to  rounds vitality 6': {'1.92': 'ggbet'},
                    '1-st map: race to  rounds vitality 9': {'1.92': 'ggbet'},
                    ...
                    '1-st map: vitality total over 11.5': {'1.35': 'ggbet'},
                    '1-st map: vitality total over 12.5': {'1.46': 'ggbet'},
                    '1-st map: vitality total over 13.5': {'1.59': 'ggbet'},
                    '1-st map: vitality total over 14.5': {'1.75': 'ggbet'},
                    '1-st map: vitality total over 15.5': {'2.19': 'ggbet'},
                    '1-st map: vitality total under 10.5': {'3.7': 'ggbet'},
                    '1-st map: vitality total under 11.5': {'3.04': 'ggbet'},
                    '1-st map: vitality total under 12.5': {'2.6': 'ggbet'},
                    '1-st map: vitality total under 13.5': {'2.27': 'ggbet'},
                    '1-st map: vitality total under 14.5': {'2.01': 'ggbet'},
                    '1-st map: vitality total under 15.5': {'1.63': 'ggbet'},
                    '1-st map: vitality will win': {'1.96': 'ggbet'},
                    ...
                    '1st map first half - big total over 7.5': {'1.82': 'ggbet'},
                    '1st map first half - big total over 8.5': {'2.54': 'ggbet'},
                    '1st map first half - big total over 9.5': {'3.89': 'ggbet'},
                    '1st map first half - big total under 6.5': {'2.73': 'ggbet'},
                    '1st map first half - big total under 7.5': {'1.92': 'ggbet'},
                    '1st map first half - big total under 8.5': {'1.48': 'ggbet'},
                    '1st map first half - big total under 9.5': {'1.23': 'ggbet'},
                    '1st map first half - big will win': {'1.82': 'ggbet'},
                    '1st map first half - handicap big +0.5': {'1.82': 'ggbet'},
                    '1st map first half - handicap big +2.5': {'1.42': 'ggbet'},
                    '1st map first half - handicap big -1.5': {'2.54': 'ggbet'},
                    '1st map first half - handicap big -3.5': {'3.89': 'ggbet'},
                    '1st map first half - handicap vitality +1.5': {'1.48': 'ggbet'},
                    '1st map first half - handicap vitality +3.5': {'1.23': 'ggbet'},
                    '1st map first half - handicap vitality -0.5': {'1.92': 'ggbet'},
                    '1st map first half - handicap vitality -2.5': {'2.73': 'ggbet'},
                    '1st map first half - vitality total over 5.5': {'1.23': 'ggbet'},
                    '1st map first half - vitality total over 6.5': {'1.48': 'ggbet'},
                    '1st map first half - vitality total over 7.5': {'1.92': 'ggbet'},
                    '1st map first half - vitality total over 8.5': {'2.73': 'ggbet'},
                    '1st map first half - vitality total under 5.5': {'3.89': 'ggbet'},
                    '1st map first half - vitality total under 6.5': {'2.54': 'ggbet'},
                    '1st map first half - vitality total under 7.5': {'1.82': 'ggbet'},
                    '1st map first half - vitality total under 8.5': {'1.42': 'ggbet'},
                    '1st map first half - vitality will win': {'1.92': 'ggbet'},
                    '1st map second half - 1x2 big': {'1.92': 'ggbet'},
                    '1st map second half - 1x2 draw': {'9.45': 'ggbet'},
                    '1st map second half - 1x2 vitality': {'2.05': 'ggbet'},
                    '1st map second half - handicap big +1.5': {'1.47': 'ggbet'},
                    '1st map second half - handicap big +3.5': {'1.21': 'ggbet'},
                    '1st map second half - handicap big -0.5': {'1.92': 'ggbet'},
                    '1st map second half - handicap big -2.5': {'2.81': 'ggbet'},
                    '1st map second half - handicap vitality +0.5': {'1.82': 'ggbet'},
                    '1st map second half - handicap vitality +2.5': {'1.4': 'ggbet'},
                    '1st map second half - handicap vitality -1.5': {'2.57': 'ggbet'},
                    '1st map second half - handicap vitality -3.5': {'4.11': 'ggbet'},
                    '2-nd map: big total over 10.5': {'1.21': 'ggbet'},
                    '2-nd map: big total over 11.5': {'1.28': 'ggbet'},
                    '2-nd map: big total over 12.5': {'1.38': 'ggbet'},
                    '2-nd map: big total over 13.5': {'1.49': 'ggbet'},
                    '2-nd map: big total over 14.5': {'1.63': 'ggbet'},
                    '2-nd map: big total over 15.5': {'1.99': 'ggbet'},
                    '2-nd map: big total under 10.5': {'4.11': 'ggbet'},
                    '2-nd map: big total under 11.5': {'3.46': 'ggbet'},
                    '2-nd map: big total under 12.5': {'2.9': 'ggbet'},
                    '2-nd map: big total under 13.5': {'2.51': 'ggbet'},
                    '2-nd map: big total under 14.5': {'2.19': 'ggbet'},
                    '2-nd map: big total under 15.5': {'1.76': 'ggbet'},
                    '2-nd map: big will win': {'1.78': 'ggbet'},
                    '2-nd map: big will win round 1': {'1.86': 'ggbet'},
                    '2-nd map: correct score 10t-e': {'10.39': 'ggbet'},
                    '2-nd map: correct score 11t-e': {'10.05': 'ggbet'},
                    '2-nd map: correct score 12t-e': {'9.84': 'ggbet'},
                    '2-nd map: correct score 13t-e': {'9.75': 'ggbet'},
                    '2-nd map: correct score 14t-e': {'9.77': 'ggbet'},
                    '2-nd map: correct score 16t-e': {'9.91': 'ggbet'},
                    '2-nd map: correct score 1t-e': {'100': 'ggbet'},
                    '2-nd map: correct score 2t-e': {'87.05': 'ggbet'},
                    '2-nd map: correct score 3t-e': {'46.06': 'ggbet'},
                    '2-nd map: correct score 4t-e': {'29.59': 'ggbet'},
                    '2-nd map: correct score 5t-e': {'21.72': 'ggbet'},
                    '2-nd map: correct score 6t-e': {'17.44': 'ggbet'},
                    '2-nd map: correct score 7t-e': {'14.87': 'ggbet'},
                    '2-nd map: correct score 8t-e': {'13.2': 'ggbet'},
                    '2-nd map: correct score 9t-e': {'12.06': 'ggbet'},
                    ...
                    '2-nd map: first half correct score 1h-t': {'81.04': 'ggbet'},
                    '2-nd map: first half correct score 2h-t': {'27.37': 'ggbet'},
                    '2-nd map: first half correct score 3h-t': {'14.62': 'ggbet'},
                    '2-nd map: first half correct score 4h-t': {'9.25': 'ggbet'},
                    '2-nd map: first half correct score 5h-t': {'6.98': 'ggbet'},
                    '2-nd map: first half correct score h-t': {'5.86': 'ggbet'},
                    '2-nd map: handicap big +1.5': {'1.63': 'ggbet'},
                    '2-nd map: handicap big +2.5': {'1.49': 'ggbet'},
                    '2-nd map: handicap big +3.5': {'1.38': 'ggbet'},
                    '2-nd map: handicap big +4.5': {'1.28': 'ggbet'},
                    '2-nd map: handicap big +5.5': {'1.21': 'ggbet'},
                    '2-nd map: handicap big -1.5': {'1.99': 'ggbet'},
                    '2-nd map: handicap big -2.5': {'2.27': 'ggbet'},
                    '2-nd map: handicap big -3.5': {'2.6': 'ggbet'},
                    '2-nd map: handicap big -4.5': {'3.04': 'ggbet'},
                    '2-nd map: handicap big -5.5': {'3.62': 'ggbet'},
                    '2-nd map: handicap vitality +1.5': {'1.76': 'ggbet'},
                    '2-nd map: handicap vitality +2.5': {'1.59': 'ggbet'},
                    '2-nd map: handicap vitality +3.5': {'1.46': 'ggbet'},
                    '2-nd map: handicap vitality +4.5': {'1.35': 'ggbet'},
                    '2-nd map: handicap vitality +5.5': {'1.26': 'ggbet'},
                    '2-nd map: handicap vitality -1.5': {'2.19': 'ggbet'},
                    '2-nd map: handicap vitality -2.5': {'2.51': 'ggbet'},
                    '2-nd map: handicap vitality -3.5': {'2.9': 'ggbet'},
                    '2-nd map: handicap vitality -4.5': {'3.46': 'ggbet'},
                    '2-nd map: handicap vitality -5.5': {'4.11': 'ggbet'},
                    '2-nd map: race to  rounds big 12': {'1.8': 'ggbet'},
                    '2-nd map: race to  rounds big 3': {'1.84': 'ggbet'},
                    '2-nd map: race to  rounds big 6': {'1.82': 'ggbet'},
                    '2-nd map: race to  rounds big 9': {'1.81': 'ggbet'},
                    '2-nd map: race to  rounds vitality 12': {'1.94': 'ggbet'},
                    '2-nd map: race to  rounds vitality 3': {'1.9': 'ggbet'},
                    '2-nd map: race to  rounds vitality 6': {'1.92': 'ggbet'},
                    '2-nd map: race to  rounds vitality 9': {'1.93': 'ggbet'},
                    ...
                    '2-nd map: vitality total over 11.5': {'1.35': 'ggbet'},
                    '2-nd map: vitality total over 12.5': {'1.46': 'ggbet'},
                    '2-nd map: vitality total over 13.5': {'1.59': 'ggbet'},
                    '2-nd map: vitality total over 14.5': {'1.75': 'ggbet'},
                    '2-nd map: vitality total over 15.5': {'2.19': 'ggbet'},
                    '2-nd map: vitality total under 10.5': {'3.7': 'ggbet'},
                    '2-nd map: vitality total under 11.5': {'3.04': 'ggbet'},
                    '2-nd map: vitality total under 12.5': {'2.6': 'ggbet'},
                    '2-nd map: vitality total under 13.5': {'2.27': 'ggbet'},
                    '2-nd map: vitality total under 14.5': {'2.01': 'ggbet'},
                    '2-nd map: vitality total under 15.5': {'1.63': 'ggbet'},
                    '2-nd map: vitality will win': {'1.97': 'ggbet'},
                    ...
                    '2nd map first half - big total over 7.5': {'1.82': 'ggbet'},
                    '2nd map first half - big total over 8.5': {'2.54': 'ggbet'},
                    '2nd map first half - big total over 9.5': {'3.89': 'ggbet'},
                    '2nd map first half - big total under 6.5': {'2.73': 'ggbet'},
                    '2nd map first half - big total under 7.5': {'1.92': 'ggbet'},
                    '2nd map first half - big total under 8.5': {'1.48': 'ggbet'},
                    '2nd map first half - big total under 9.5': {'1.23': 'ggbet'},
                    '2nd map first half - big will win': {'1.82': 'ggbet'},
                    '2nd map first half - handicap big +0.5': {'1.82': 'ggbet'},
                    '2nd map first half - handicap big +2.5': {'1.42': 'ggbet'},
                    '2nd map first half - handicap big -1.5': {'2.54': 'ggbet'},
                    '2nd map first half - handicap big -3.5': {'3.89': 'ggbet'},
                    '2nd map first half - handicap vitality +1.5': {'1.48': 'ggbet'},
                    '2nd map first half - handicap vitality +3.5': {'1.23': 'ggbet'},
                    '2nd map first half - handicap vitality -0.5': {'1.92': 'ggbet'},
                    '2nd map first half - handicap vitality -2.5': {'2.73': 'ggbet'},
                    '2nd map first half - vitality total over 5.5': {'1.23': 'ggbet'},
                    '2nd map first half - vitality total over 6.5': {'1.48': 'ggbet'},
                    '2nd map first half - vitality total over 7.5': {'1.92': 'ggbet'},
                    '2nd map first half - vitality total over 8.5': {'2.73': 'ggbet'},
                    '2nd map first half - vitality total under 5.5': {'3.89': 'ggbet'},
                    '2nd map first half - vitality total under 6.5': {'2.54': 'ggbet'},
                    '2nd map first half - vitality total under 7.5': {'1.82': 'ggbet'},
                    '2nd map first half - vitality total under 8.5': {'1.42': 'ggbet'},
                    '2nd map first half - vitality will win': {'1.92': 'ggbet'},
                    '2nd map second half - 1x2 big': {'1.92': 'ggbet'},
                    '2nd map second half - 1x2 draw': {'9.46': 'ggbet'},
                    '2nd map second half - 1x2 vitality': {'2.05': 'ggbet'},
                    '2nd map second half - handicap big +1.5': {'1.47': 'ggbet'},
                    '2nd map second half - handicap big +3.5': {'1.21': 'ggbet'},
                    '2nd map second half - handicap big -0.5': {'1.92': 'ggbet'},
                    '2nd map second half - handicap big -2.5': {'2.81': 'ggbet'},
                    '2nd map second half - handicap vitality +0.5': {'1.82': 'ggbet'},
                    '2nd map second half - handicap vitality +2.5': {'1.4': 'ggbet'},
                    '2nd map second half - handicap vitality -1.5': {'2.57': 'ggbet'},
                    '2nd map second half - handicap vitality -3.5': {'4.11': 'ggbet'},
                    'big handicap +1.5 maps': {'1.25': 'ggbet'},
                    'big handicap -1.5 maps': {'3.2': 'ggbet'},
                    ...
                    'big will win': {'1.78': 'ggbet'},
                    'correct score 0-2': {'3.74': 'ggbet'},
                    'correct score 1-2': {'3.72': 'ggbet'},
                    'correct score 2-0': {'3.19': 'ggbet'},
                    'correct score 2-1': {'3.44': 'ggbet'},
                    'handicap big +2.5': {'1.59': 'ggbet'},
                    'handicap big +4.5': {'1.48': 'ggbet'},
                    'handicap big +6.5': {'1.34': 'ggbet'},
                    'handicap big +8.5': {'1.23': 'ggbet'},
                    'handicap big -0.5': {'1.78': 'ggbet'},
                    'handicap big -3.5': {'2.02': 'ggbet'},
                    'handicap big -5.5': {'2.31': 'ggbet'},
                    'handicap big -7.5': {'2.81': 'ggbet'},
                    'handicap big -9.5': {'3.62': 'ggbet'},
                    'handicap vitality +0.5': {'1.97': 'ggbet'},
                    'handicap vitality +3.5': {'1.74': 'ggbet'},
                    'handicap vitality +5.5': {'1.57': 'ggbet'},
                    'handicap vitality +7.5': {'1.4': 'ggbet'},
                    'handicap vitality +9.5': {'1.26': 'ggbet'},
                    'handicap vitality -2.5': {'2.27': 'ggbet'},
                    'handicap vitality -4.5': {'2.54': 'ggbet'},
                    'handicap vitality -6.5': {'3.09': 'ggbet'},
                    'handicap vitality -8.5': {'3.89': 'ggbet'},
                    ...
                    'vitality handicap +1.5 maps': {'1.32': 'ggbet'},
                    'vitality handicap -1.5 maps': {'3.7': 'ggbet'},
                    'vitality total over 25.5': {'1.23': 'ggbet'},
                    'vitality total over 32.5': {'1.83': 'ggbet'},
                    'vitality total over 36.5': {'2.29': 'ggbet'},
                    'vitality total over 40.5': {'3.2': 'ggbet'},
                    'vitality total under 25.5': {'3.89': 'ggbet'},
                    'vitality total under 32.5': {'1.91': 'ggbet'},
                    'vitality total under 36.5': {'1.58': 'ggbet'},
                    'vitality total under 40.5': {'1.32': 'ggbet'},
                    'vitality will win': {'1.99': 'ggbet'}},
 'bravos gaming - sws gaming': {'1-st map: bravos gaming will win': {'1.51': 'ggbet'},
 ...
 'brute - tikitakan': {'1-st map: brute will win': {'2.11': 'ggbet'},
                       '1-st map: brute will win round 1': {'1.9': 'ggbet'},
                       '1-st map: handicap brute +1.5': {'1.89': 'ggbet'},
                       '1-st map: handicap brute +2.5': {'1.71': 'ggbet'},
                       '1-st map: handicap brute +3.5': {'1.56': 'ggbet'},
                       '1-st map: handicap brute +4.5': {'1.43': 'ggbet'},
                       '1-st map: handicap brute +5.5': {'1.33': 'ggbet'},
                       '1-st map: handicap brute +6.5': {'1.24': 'ggbet'},
                       '1-st map: handicap brute -1.5': {'2.35': 'ggbet'},
                       '1-st map: handicap brute -2.5': {'2.66': 'ggbet'},
                       '1-st map: handicap brute -3.5': {'3.04': 'ggbet'},
                       '1-st map: handicap brute -4.5': {'3.54': 'ggbet'},
                       '1-st map: handicap tikitakan +1.5': {'1.55': 'ggbet'},
                       '1-st map: handicap tikitakan +2.5': {'1.44': 'ggbet'},
                       '1-st map: handicap tikitakan +3.5': {'1.35': 'ggbet'},
                       '1-st map: handicap tikitakan +4.5': {'1.27': 'ggbet'},
                       '1-st map: handicap tikitakan -1.5': {'1.85': 'ggbet'},
                       '1-st map: handicap tikitakan -2.5': {'2.06': 'ggbet'},
                       '1-st map: handicap tikitakan -3.5': {'2.33': 'ggbet'},
                       '1-st map: handicap tikitakan -4.5': {'2.7': 'ggbet'},
                       '1-st map: handicap tikitakan -5.5': {'3.14': 'ggbet'},
                       '1-st map: handicap tikitakan -6.5': {'3.79': 'ggbet'},
                       '1-st map: tikitakan will win': {'1.68': 'ggbet'},
                       '1-st map: tikitakan will win round 1': {'1.84': 'ggbet'},
                       '1-st map: total over 23.5': {'1.22': 'ggbet'},
                       '1-st map: total over 24.5': {'1.35': 'ggbet'},
                       '1-st map: total over 25.5': {'1.53': 'ggbet'},
                       '1-st map: total over 26.5': {'1.8': 'ggbet'},
                       ...
                       '1-st map: total under 26.5': {'1.94': 'ggbet'},
                       '1-st map: total under 27.5': {'1.62': 'ggbet'},
                       '1-st map: total under 28.5': {'1.39': 'ggbet'},
                       '1-st map: total under 29.5': {'1.21': 'ggbet'},
                       '2-nd map: brute will win': {'2.11': 'ggbet'},
                       '2-nd map: brute will win round 1': {'1.89': 'ggbet'},
                       '2-nd map: handicap brute +1.5': {'1.89': 'ggbet'},
                       '2-nd map: handicap brute +2.5': {'1.72': 'ggbet'},
                       '2-nd map: handicap brute +3.5': {'1.57': 'ggbet'},
                       '2-nd map: handicap brute +4.5': {'1.44': 'ggbet'},
                       '2-nd map: handicap brute +5.5': {'1.33': 'ggbet'},
                       '2-nd map: handicap brute +6.5': {'1.24': 'ggbet'},
                       '2-nd map: handicap brute -1.5': {'2.33': 'ggbet'},
                       '2-nd map: handicap brute -2.5': {'2.63': 'ggbet'},
                       '2-nd map: handicap brute -3.5': {'3.04': 'ggbet'},
                       '2-nd map: handicap brute -4.5': {'3.54': 'ggbet'},
                       '2-nd map: handicap brute -5.5': {'4.23': 'ggbet'},
                       '2-nd map: handicap tikitakan +1.5': {'1.56': 'ggbet'},
                       '2-nd map: handicap tikitakan +2.5': {'1.45': 'ggbet'},
                       '2-nd map: handicap tikitakan +3.5': {'1.35': 'ggbet'},
                       '2-nd map: handicap tikitakan +4.5': {'1.27': 'ggbet'},
                       '2-nd map: handicap tikitakan +5.5': {'1.2': 'ggbet'},
                       '2-nd map: handicap tikitakan -1.5': {'1.85': 'ggbet'},
                       '2-nd map: handicap tikitakan -2.5': {'2.05': 'ggbet'},
                       '2-nd map: handicap tikitakan -3.5': {'2.31': 'ggbet'},
                       '2-nd map: handicap tikitakan -4.5': {'2.66': 'ggbet'},
                       '2-nd map: handicap tikitakan -5.5': {'3.14': 'ggbet'},
                       '2-nd map: handicap tikitakan -6.5': {'3.79': 'ggbet'},
                       '2-nd map: tikitakan will win': {'1.68': 'ggbet'},
                       '2-nd map: tikitakan will win round 1': {'1.85': 'ggbet'},
                       '2-nd map: total over 23.5': {'1.23': 'ggbet'},
                       '2-nd map: total over 24.5': {'1.36': 'ggbet'},
                       '2-nd map: total over 25.5': {'1.54': 'ggbet'},
                       '2-nd map: total over 26.5': {'1.81': 'ggbet'},
                       '2-nd map: total over 27.5': {'2.21': 'ggbet'},
                       ...
                       '2-nd map: total under 25.5': {'2.38': 'ggbet'},
                       '2-nd map: total under 26.5': {'1.93': 'ggbet'},
                       '2-nd map: total under 27.5': {'1.62': 'ggbet'},
                       '2-nd map: total under 28.5': {'1.39': 'ggbet'},
                       '2-nd map: total under 29.5': {'1.21': 'ggbet'},
                       'brute handicap +1.5 maps': {'1.44': 'ggbet'},
                       'brute handicap -1.5 maps': {'3.89': 'ggbet'},
                       'brute will win': {'2.2': 'ggbet'},
                       'correct score 0-2': {'2.65': 'ggbet'},
                       'correct score 1-2': {'3.65': 'ggbet'},
                       'correct score 2-0': {'3.9': 'ggbet'},
                       'correct score 2-1': {'4.3': 'ggbet'},
                       'odd/even maps even': {'1.68': 'ggbet'},
                       'odd/even maps odd': {'2.11': 'ggbet'},
                       'tikitakan handicap +1.5 maps': {'1.23': 'ggbet'},
                       'tikitakan handicap -1.5 maps': {'2.66': 'ggbet'},
                       'tikitakan will win': {'1.64': 'ggbet'},
                       'total maps over 2.5': {'2.11': 'ggbet'},
                       'total maps under 2.5': {'1.68': 'ggbet'}},
 'chiefs - truckers with attitude': {'1-st map: chiefs will win': {'1.24': 'ggbet'},
                                     '1-st map: chiefs will win round 1': {'1.75': 'ggbet'},
                                     '1-st map: handicap chiefs -1.5': {'1.33': 'ggbet'},
                                     '1-st map: handicap chiefs -2.5': {'1.44': 'ggbet'},
                                     '1-st map: handicap chiefs -3.5': {'1.57': 'ggbet'},
                                     '1-st map: handicap chiefs -4.5': {'1.74': 'ggbet'},
                                     '1-st map: handicap chiefs -5.5': {'1.98': 'ggbet'},
                                     '1-st map: handicap chiefs -6.5': {'2.31': 'ggbet'},
                                     '1-st map: handicap chiefs -7.5': {'2.77': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +1.5': {'3.14': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +2.5': {'2.66': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +3.5': {'2.31': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +4.5': {'2.02': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +5.5': {'1.77': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +6.5': {'1.57': 'ggbet'},
                                     '1-st map: handicap truckers with attitude +7.5': {'1.41': 'ggbet'},
                                     '1-st map: total over 23.5': {'1.33': 'ggbet'},
                                     '1-st map: total over 24.5': {'1.5': 'ggbet'},
                                     '1-st map: total over 25.5': {'1.74': 'ggbet'},
                                     '1-st map: total over 26.5': {'2.08': 'ggbet'},
                                     '1-st map: total over 27.5': {'2.57': 'ggbet'},
                                     '1-st map: total under 23.5': {'3.14': 'ggbet'},
                                     '1-st map: total under 24.5': {'2.48': 'ggbet'},
                                     '1-st map: total under 25.5': {'2.02': 'ggbet'},
                                     '1-st map: total under 26.5': {'1.7': 'ggbet'},
                                     '1-st map: total under 27.5': {'1.47': 'ggbet'},
                                     '1-st map: truckers with attitude will win': {'3.79': 'ggbet'},
                                     '1-st map: truckers with attitude will win round 1': {'2.01': 'ggbet'},
                                     '2-nd map: chiefs will win': {'1.24': 'ggbet'},
                                     '2-nd map: chiefs will win round 1': {'1.75': 'ggbet'},
                                     '2-nd map: handicap chiefs -1.5': {'1.33': 'ggbet'},
                                     '2-nd map: handicap chiefs -2.5': {'1.43': 'ggbet'},
                                     '2-nd map: handicap chiefs -3.5': {'1.55': 'ggbet'},
                                     '2-nd map: handicap chiefs -4.5': {'1.72': 'ggbet'},
                                     '2-nd map: handicap chiefs -5.5': {'1.96': 'ggbet'},
                                     '2-nd map: handicap chiefs -6.5': {'2.27': 'ggbet'},
                                     '2-nd map: handicap chiefs -7.5': {'2.73': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +1.5': {'3.14': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +2.5': {'2.7': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +3.5': {'2.35': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +4.5': {'2.05': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +5.5': {'1.79': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +6.5': {'1.59': 'ggbet'},
                                     '2-nd map: handicap truckers with attitude +7.5': {'1.42': 'ggbet'},
                                     '2-nd map: total over 23.5': {'1.34': 'ggbet'},
                                     '2-nd map: total over 24.5': {'1.51': 'ggbet'},
                                     '2-nd map: total over 25.5': {'1.75': 'ggbet'},
                                     '2-nd map: total over 26.5': {'2.09': 'ggbet'},
                                     '2-nd map: total over 27.5': {'2.6': 'ggbet'},
                                     '2-nd map: total under 23.5': {'3.09': 'ggbet'},
                                     '2-nd map: total under 24.5': {'2.45': 'ggbet'},
                                     '2-nd map: total under 25.5': {'2.01': 'ggbet'},
                                     '2-nd map: total under 26.5': {'1.69': 'ggbet'},
                                     '2-nd map: total under 27.5': {'1.46': 'ggbet'},
                                     '2-nd map: truckers with attitude will win': {'3.79': 'ggbet'},
                                     '2-nd map: truckers with attitude will win round 1': {'2.01': 'ggbet'},
                                     'chiefs handicap +1.5 maps': {'1.04': 'ggbet'},
                                     'chiefs handicap -1.5 maps': {'1.55': 'ggbet'},
                                     'chiefs will win': {'1.15': 'ggbet'},
                                     'correct score 0-2': {'8.93': 'ggbet'},
                                     'correct score 1-2': {'7.85': 'ggbet'},
                                     'correct score 2-0': {'1.55': 'ggbet'},
                                     'correct score 2-1': {'3.77': 'ggbet'},
                                     'odd/even maps even': {'1.4': 'ggbet'},
                                     'odd/even maps odd': {'2.81': 'ggbet'},
                                     'total maps over 2.5': {'2.81': 'ggbet'},
                                     'total maps under 2.5': {'1.4': 'ggbet'},
                                     'truckers with attitude handicap +1.5 maps': {'2.35': 'ggbet'},
                                     'truckers with attitude handicap -1.5 maps': {'9.22': 'ggbet'},
                                     'truckers with attitude will win': {'5.12': 'ggbet'}},
 'cr4zy - nemiga': {'1-st map: cr4zy will win': {'3.7': 'ggbet'},
                    '1-st map: cr4zy will win round 1': {'2.01': 'ggbet'},
                    '1-st map: handicap cr4zy +1.5': {'3.09': 'ggbet'},
                    '1-st map: handicap cr4zy +2.5': {'2.66': 'ggbet'},
                    '1-st map: handicap cr4zy +3.5': {'2.31': 'ggbet'},
                    '1-st map: handicap cr4zy +4.5': {'2.01': 'ggbet'},
                    '1-st map: handicap cr4zy +5.5': {'1.76': 'ggbet'},
                    '1-st map: handicap cr4zy +6.5': {'1.56': 'ggbet'},
                    '1-st map: handicap cr4zy +7.5': {'1.4': 'ggbet'},
                    '1-st map: handicap nemiga -1.5': {'1.34': 'ggbet'},
                    '1-st map: handicap nemiga -2.5': {'1.44': 'ggbet'},
                    '1-st map: handicap nemiga -3.5': {'1.57': 'ggbet'},
                    '1-st map: handicap nemiga -4.5': {'1.75': 'ggbet'},
                    '1-st map: handicap nemiga -5.5': {'1.99': 'ggbet'},
                    '1-st map: handicap nemiga -6.5': {'2.33': 'ggbet'},
                    '1-st map: handicap nemiga -7.5': {'2.81': 'ggbet'},
                    '1-st map: nemiga will win': {'1.25': 'ggbet'},
                    '1-st map: nemiga will win round 1': {'1.75': 'ggbet'},
                    '1-st map: total over 23.5': {'1.33': 'ggbet'},
                    '1-st map: total over 24.5': {'1.5': 'ggbet'},
                    '1-st map: total over 25.5': {'1.73': 'ggbet'},
                    '1-st map: total over 26.5': {'2.06': 'ggbet'},
                    '1-st map: total over 27.5': {'2.57': 'ggbet'},
                    '1-st map: total under 23.5': {'3.14': 'ggbet'},
                    '1-st map: total under 24.5': {'2.48': 'ggbet'},
                    '1-st map: total under 25.5': {'2.03': 'ggbet'},
                    '1-st map: total under 26.5': {'1.71': 'ggbet'},
                    '1-st map: total under 27.5': {'1.47': 'ggbet'},
                    '2-nd map: cr4zy will win': {'3.7': 'ggbet'},
                    '2-nd map: cr4zy will win round 1': {'2.01': 'ggbet'},
                    '2-nd map: handicap cr4zy +1.5': {'3.14': 'ggbet'},
                    '2-nd map: handicap cr4zy +2.5': {'2.7': 'ggbet'},
                    '2-nd map: handicap cr4zy +3.5': {'2.33': 'ggbet'},
                    '2-nd map: handicap cr4zy +4.5': {'2.02': 'ggbet'},
                    '2-nd map: handicap cr4zy +5.5': {'1.77': 'ggbet'},
                    '2-nd map: handicap cr4zy +6.5': {'1.57': 'ggbet'},
                    '2-nd map: handicap cr4zy +7.5': {'1.41': 'ggbet'},
                    '2-nd map: handicap nemiga -1.5': {'1.33': 'ggbet'},
                    '2-nd map: handicap nemiga -2.5': {'1.43': 'ggbet'},
                    '2-nd map: handicap nemiga -3.5': {'1.56': 'ggbet'},
                    '2-nd map: handicap nemiga -4.5': {'1.74': 'ggbet'},
                    '2-nd map: handicap nemiga -5.5': {'1.98': 'ggbet'},
                    '2-nd map: handicap nemiga -6.5': {'2.31': 'ggbet'},
                    '2-nd map: handicap nemiga -7.5': {'2.77': 'ggbet'},
                    '2-nd map: nemiga will win': {'1.25': 'ggbet'},
                    '2-nd map: nemiga will win round 1': {'1.75': 'ggbet'},
                    '2-nd map: total over 23.5': {'1.34': 'ggbet'},
                    '2-nd map: total over 24.5': {'1.51': 'ggbet'},
                    '2-nd map: total over 25.5': {'1.74': 'ggbet'},
                    '2-nd map: total over 26.5': {'2.08': 'ggbet'},
                    '2-nd map: total over 27.5': {'2.57': 'ggbet'},
                    '2-nd map: total under 23.5': {'3.09': 'ggbet'},
                    '2-nd map: total under 24.5': {'2.45': 'ggbet'},
                    '2-nd map: total under 25.5': {'2.02': 'ggbet'},
                    '2-nd map: total under 26.5': {'1.7': 'ggbet'},
                    '2-nd map: total under 27.5': {'1.47': 'ggbet'},
                    'correct score 0-2': {'1.55': 'ggbet'},
                    'correct score 1-2': {'3.77': 'ggbet'},
                    'correct score 2-0': {'8.9': 'ggbet'},
                    'correct score 2-1': {'7.82': 'ggbet'},
                    'cr4zy handicap +1.5 maps': {'2.35': 'ggbet'},
                    'cr4zy handicap -1.5 maps': {'9.22': 'ggbet'},
                    'cr4zy will win': {'5.12': 'ggbet'},
                    'nemiga handicap +1.5 maps': {'1.04': 'ggbet'},
                    'nemiga handicap -1.5 maps': {'1.55': 'ggbet'},
                    'nemiga will win': {'1.15': 'ggbet'},
                    'odd/even maps even': {'1.4': 'ggbet'},
                    'odd/even maps odd': {'2.81': 'ggbet'},
                    'total maps over 2.5': {'2.81': 'ggbet'},
                    'total maps under 2.5': {'1.4': 'ggbet'}},
 'cream real betis - neverest': {'1-st map: cream real betis will win': {'1.57': 'ggbet'},
 ...
 'd13 - divine vendetta': {'1-st map: d13 will win': {'1.6': 'ggbet'},
                           '1-st map: d13 will win round 1': {'1.83': 'ggbet'},
                           '1-st map: divine vendetta will win': {'2.25': 'ggbet'},
                           '1-st map: divine vendetta will win round 1': {'1.91': 'ggbet'},
                           '1-st map: handicap d13 -1.5': {'1.76': 'ggbet'},
                           '1-st map: handicap d13 -2.5': {'1.94': 'ggbet'},
                           '1-st map: handicap d13 -3.5': {'2.19': 'ggbet'},
                           '1-st map: handicap divine vendetta +1.5': {'1.99': 'ggbet'},
                           '1-st map: handicap divine vendetta +2.5': {'1.8': 'ggbet'},
                           '1-st map: handicap divine vendetta +3.5': {'1.63': 'ggbet'},
                           '1-st map: total over 26.5': {'1.81': 'ggbet'},
                           '1-st map: total over 27.5': {'2.21': 'ggbet'},
                           '1-st map: total under 26.5': {'1.93': 'ggbet'},
                           '1-st map: total under 27.5': {'1.62': 'ggbet'},
                           '2-nd map: d13 will win': {'1.61': 'ggbet'},
                           '2-nd map: d13 will win round 1': {'1.83': 'ggbet'},
                           '2-nd map: divine vendetta will win': {'2.23': 'ggbet'},
                           '2-nd map: divine vendetta will win round 1': {'1.91': 'ggbet'},
                           '2-nd map: handicap d13 -1.5': {'1.76': 'ggbet'},
                           '2-nd map: handicap d13 -2.5': {'1.94': 'ggbet'},
                           '2-nd map: handicap d13 -3.5': {'2.19': 'ggbet'},
                           '2-nd map: handicap divine vendetta +1.5': {'1.99': 'ggbet'},
                           '2-nd map: handicap divine vendetta +2.5': {'1.8': 'ggbet'},
                           '2-nd map: handicap divine vendetta +3.5': {'1.63': 'ggbet'},
                           ...
                           'correct score 0-2': {'4.32': 'ggbet'},
                           'correct score 1-2': {'4.56': 'ggbet'},
                           'correct score 2-0': {'2.44': 'ggbet'},
                           'correct score 2-1': {'3.57': 'ggbet'},
                           'd13 handicap +1.5 maps': {'1.19': 'ggbet'},
                           'd13 handicap -1.5 maps': {'2.43': 'ggbet'},
                           'd13 will win': {'1.54': 'ggbet'},
                           'divine vendetta handicap +1.5 maps': {'1.52': 'ggbet'},
                           'divine vendetta handicap -1.5 maps': {'4.35': 'ggbet'},
                           'divine vendetta will win': {'2.41': 'ggbet'},
                           'odd/even maps even': {'1.66': 'ggbet'},
                           'odd/even maps odd': {'2.14': 'ggbet'},
                           'total maps over 2.5': {'2.14': 'ggbet'},
                           'total maps under 2.5': {'1.66': 'ggbet'}},
 'divine vendetta - vici': {'1-st map: divine vendetta will win': {'4.11': 'ggbet'},
                            '1-st map: divine vendetta will win round 1': {'2.02': 'ggbet'},
                            '1-st map: handicap divine vendetta +4.5': {'2.14': 'ggbet'},
                            '1-st map: handicap divine vendetta +5.5': {'1.86': 'ggbet'},
                            '1-st map: handicap divine vendetta +6.5': {'1.63': 'ggbet'},
                            '1-st map: handicap vici -4.5': {'1.66': 'ggbet'},
                            '1-st map: handicap vici -5.5': {'1.88': 'ggbet'},
                            '1-st map: handicap vici -6.5': {'2.19': 'ggbet'},
                            ...
                            '1-st map: vici will win': {'1.21': 'ggbet'},
                            '1-st map: vici will win round 1': {'1.74': 'ggbet'},
                            '2-nd map: divine vendetta will win': {'4.11': 'ggbet'},
                            '2-nd map: divine vendetta will win round 1': {'2.02': 'ggbet'},
                            '2-nd map: handicap divine vendetta +4.5': {'2.16': 'ggbet'},
                            '2-nd map: handicap divine vendetta +5.5': {'1.87': 'ggbet'},
                            '2-nd map: handicap divine vendetta +6.5': {'1.64': 'ggbet'},
                            '2-nd map: handicap vici -4.5': {'1.65': 'ggbet'},
                            '2-nd map: handicap vici -5.5': {'1.87': 'ggbet'},
                            '2-nd map: handicap vici -6.5': {'2.17': 'ggbet'},
                            ...
                            '2-nd map: vici will win': {'1.21': 'ggbet'},
                            '2-nd map: vici will win round 1': {'1.74': 'ggbet'},
                            'correct score 0-2': {'1.47': 'ggbet'},
                            'correct score 1-2': {'3.94': 'ggbet'},
                            'correct score 2-0': {'9.89': 'ggbet'},
                            'correct score 2-1': {'8.65': 'ggbet'},
                            'divine vendetta handicap +1.5 maps': {'2.57': 'ggbet'},
                            'divine vendetta handicap -1.5 maps': {'10.09': 'ggbet'},
                            'divine vendetta will win': {'5.81': 'ggbet'},
                            'odd/even maps even': {'1.36': 'ggbet'},
                            'odd/even maps odd': {'2.99': 'ggbet'},
                            'total maps over 2.5': {'2.99': 'ggbet'},
                            'total maps under 2.5': {'1.36': 'ggbet'},
                            'vici handicap +1.5 maps': {'1.03': 'ggbet'},
                            'vici handicap -1.5 maps': {'1.47': 'ggbet'},
                            'vici will win': {'1.12': 'ggbet'}},
 'divizon - planetkey dynamics': {'1-st map: divizon will win': {'1.6': 'ggbet'},
                                  '1-st map: planetkey dynamics will win': {'2.25': 'ggbet'},
                                  '1x2 divizon': {'2.36': 'ggbet'},
                                  '1x2 draw': {'2.35': 'ggbet'},
                                  '1x2 planetkey dynamics': {'4.04': 'ggbet'},
                                  '2-nd map: divizon will win': {'1.61': 'ggbet'},
                                  '2-nd map: planetkey dynamics will win': {'2.23': 'ggbet'}},
 'eternal - imperium': {'1-st map: eternal will win': {'1.82': 'ggbet'},
                        '1-st map: imperium will win': {'1.92': 'ggbet'},
                        '2-nd map: eternal will win': {'1.82': 'ggbet'},
                        '2-nd map: imperium will win': {'1.92': 'ggbet'},
                        'eternal will win': {'1.83': 'ggbet'},
                        'imperium will win': {'1.93': 'ggbet'}},
 'evil geniuses - liquid': {'1-st map: correct score 10t-e': {'11.62': 'ggbet'},
 ...
 'ex-polar ace - oceanus gaming': {'1-st map: ex-polar ace will win': {'2.81': 'ggbet'},
                                   '1-st map: oceanus gaming will win': {'1.4': 'ggbet'},
                                   '2-nd map: ex-polar ace will win': {'2.81': 'ggbet'},
                                   '2-nd map: oceanus gaming will win': {'1.4': 'ggbet'},
                                   'ex-polar ace will win': {'3.32': 'ggbet'},
                                   'oceanus gaming will win': {'1.31': 'ggbet'}},
 'fnatic - godsent': {'1-st map: correct score 10-16': {'14.08': 'ggbet'},
                      '1-st map: correct score 11-16': {'13.07': 'ggbet'},
                      '1-st map: correct score 12-16': {'12.35': 'ggbet'},
                      '1-st map: correct score 13-16': {'11.85': 'ggbet'},
                      '1-st map: correct score 14-16': {'11.53': 'ggbet'},
                      '1-st map: correct score 16-1': {'100': 'ggbet'},
                      '1-st map: correct score 16-10': {'9.48': 'ggbet'},
                      '1-st map: correct score 16-11': {'9.3': 'ggbet'},
                      '1-st map: correct score 16-12': {'9.27': 'ggbet'},
                      '1-st map: correct score 16-13': {'9.36': 'ggbet'},
                      '1-st map: correct score 16-14': {'9.56': 'ggbet'},
                      '1-st map: correct score 16-2': {'59.12': 'ggbet'},
                      '1-st map: correct score 16-3': {'32.71': 'ggbet'},
                      '1-st map: correct score 16-4': {'22.13': 'ggbet'},
                      '1-st map: correct score 16-5': {'17.02': 'ggbet'},
                      '1-st map: correct score 16-6': {'14.16': 'ggbet'},
                      '1-st map: correct score 16-7': {'12.38': 'ggbet'},
                      '1-st map: correct score 16-8': {'10.34': 'ggbet'},
                      '1-st map: correct score 16-9': {'9.82': 'ggbet'},
                      '1-st map: correct score 2-16': {'100': 'ggbet'},
                      '1-st map: correct score 3-16': {'86.23': 'ggbet'},
                      '1-st map: correct score 4-16': {'50.88': 'ggbet'},
                      '1-st map: correct score 5-16': {'34.39': 'ggbet'},
                      '1-st map: correct score 6-16': {'25.7': 'ggbet'},
                      '1-st map: correct score 7-16': {'20.69': 'ggbet'},
                      '1-st map: correct score 8-16': {'17.57': 'ggbet'},
                      '1-st map: correct score 9-16': {'15.5': 'ggbet'},
                      '1-st map: ct total  over 10.5': {'1.21': 'ggbet'},
                      '1-st map: ct total  over 11.5': {'1.43': 'ggbet'},
                      '1-st map: ct total  over 13.5': {'2.11': 'ggbet'},
                      '1-st map: ct total  over 15.5': {'3.62': 'ggbet'},
                      '1-st map: ct total  under 10.5': {'4.11': 'ggbet'},
                      '1-st map: ct total  under 11.5': {'2.7': 'ggbet'},
                      '1-st map: ct total  under 13.5': {'1.68': 'ggbet'},
                      '1-st map: ct total  under 15.5': {'1.26': 'ggbet'},
                      '1-st map: first half correct score 1-14': {'100': 'ggbet'},
                      '1-st map: first half correct score 10-5': {'6.21': 'ggbet'},
                      '1-st map: first half correct score 11-4': {'8.08': 'ggbet'},
                      '1-st map: first half correct score 12-3': {'12.12': 'ggbet'},
                      '1-st map: first half correct score 13-2': {'20.8': 'ggbet'},
                      '1-st map: first half correct score 14-1': {'54.52': 'ggbet'},
                      '1-st map: first half correct score 2-13': {'45': 'ggbet'},
                      '1-st map: first half correct score 3-12': {'20.25': 'ggbet'},
                      '1-st map: first half correct score 4-11': {'12.41': 'ggbet'},
                      '1-st map: first half correct score 5-10': {'8.39': 'ggbet'},
                      '1-st map: first half correct score 6-9': {'6.46': 'ggbet'},
                      '1-st map: first half correct score 7-8': {'5.4': 'ggbet'},
                      '1-st map: first half correct score 8-7': {'5.03': 'ggbet'},
                      '1-st map: first half correct score 9-6': {'5.27': 'ggbet'},
                      '1-st map: fnatic total over 12.5': {'1.25': 'ggbet'},
                      '1-st map: fnatic total over 14.5': {'1.41': 'ggbet'},
                      '1-st map: fnatic total over 15.5': {'1.67': 'ggbet'},
                      '1-st map: fnatic total under 12.5': {'3.7': 'ggbet'},
                      '1-st map: fnatic total under 14.5': {'2.77': 'ggbet'},
                      '1-st map: fnatic total under 15.5': {'2.12': 'ggbet'},
                      '1-st map: fnatic will win': {'1.51': 'ggbet'},
                      '1-st map: fnatic will win round 1': {'1.82': 'ggbet'},
                      '1-st map: godsent total over 10.5': {'1.39': 'ggbet'},
                      '1-st map: godsent total over 11.5': {'1.52': 'ggbet'},
                      '1-st map: godsent total over 12.5': {'1.68': 'ggbet'},
                      '1-st map: godsent total over 13.5': {'1.88': 'ggbet'},
                      '1-st map: godsent total over 14.5': {'2.12': 'ggbet'},
                      '1-st map: godsent total over 15.5': {'2.77': 'ggbet'},
                      '1-st map: godsent total over 9.5': {'1.28': 'ggbet'},
                      '1-st map: godsent total under 10.5': {'2.85': 'ggbet'},
                      '1-st map: godsent total under 11.5': {'2.43': 'ggbet'},
                      '1-st map: godsent total under 12.5': {'2.11': 'ggbet'},
                      '1-st map: godsent total under 13.5': {'1.86': 'ggbet'},
                      '1-st map: godsent total under 14.5': {'1.67': 'ggbet'},
                      '1-st map: godsent total under 15.5': {'1.41': 'ggbet'},
                      '1-st map: godsent total under 9.5': {'3.46': 'ggbet'},
                      '1-st map: godsent will win': {'2.45': 'ggbet'},
                      '1-st map: godsent will win round 1': {'1.92': 'ggbet'},
                      '1-st map: handicap fnatic +1.5': {'1.41': 'ggbet'},
                      '1-st map: handicap fnatic +2.5': {'1.32': 'ggbet'},
                      '1-st map: handicap fnatic +3.5': {'1.25': 'ggbet'},
                      '1-st map: handicap fnatic -1.5': {'1.67': 'ggbet'},
                      '1-st map: handicap fnatic -2.5': {'1.86': 'ggbet'},
                      '1-st map: handicap fnatic -3.5': {'2.11': 'ggbet'},
                      '1-st map: handicap fnatic -4.5': {'2.43': 'ggbet'},
                      '1-st map: handicap fnatic -5.5': {'2.85': 'ggbet'},
                      '1-st map: handicap fnatic -6.5': {'3.46': 'ggbet'},
                      '1-st map: handicap godsent +1.5': {'2.12': 'ggbet'},
                      '1-st map: handicap godsent +2.5': {'1.88': 'ggbet'},
                      '1-st map: handicap godsent +3.5': {'1.68': 'ggbet'},
                      '1-st map: handicap godsent +4.5': {'1.52': 'ggbet'},
                      '1-st map: handicap godsent +5.5': {'1.39': 'ggbet'},
                      '1-st map: handicap godsent +6.5': {'1.28': 'ggbet'},
                      '1-st map: handicap godsent -1.5': {'2.77': 'ggbet'},
                      '1-st map: handicap godsent -2.5': {'3.2': 'ggbet'},
                      '1-st map: handicap godsent -3.5': {'3.7': 'ggbet'},
                      '1-st map: race to  rounds fnatic 12': {'1.56': 'ggbet'},
                      '1-st map: race to  rounds fnatic 3': {'1.72': 'ggbet'},
                      '1-st map: race to  rounds fnatic 6': {'1.64': 'ggbet'},
                      '1-st map: race to  rounds fnatic 9': {'1.6': 'ggbet'},
                      '1-st map: race to  rounds godsent 12': {'2.33': 'ggbet'},
                      '1-st map: race to  rounds godsent 3': {'2.05': 'ggbet'},
                      '1-st map: race to  rounds godsent 6': {'2.17': 'ggbet'},
                      '1-st map: race to  rounds godsent 9': {'2.25': 'ggbet'},
                      '1-st map: terrorist total over 10.5': {'1.21': 'ggbet'},
                      '1-st map: terrorist total over 11.5': {'1.43': 'ggbet'},
                      '1-st map: terrorist total over 13.5': {'2.11': 'ggbet'},
                      '1-st map: terrorist total over 15.5': {'3.62': 'ggbet'},
                      '1-st map: terrorist total under 10.5': {'4.11': 'ggbet'},
                      '1-st map: terrorist total under 11.5': {'2.7': 'ggbet'},
                      '1-st map: terrorist total under 13.5': {'1.68': 'ggbet'},
                      ...
                      '1-st map: total over 28.5': {'2.73': 'ggbet'},
                      ...
                      '1-st map: total under 28.5': {'1.42': 'ggbet'},
                      '1-st map: total under 29.5': {'1.23': 'ggbet'},
                      '1-st map: will there be overtime no': {'1.08': 'ggbet'},
                      '1-st map: will there be overtime yes': {'6.94': 'ggbet'},
                      '1st map first half - fnatic total over 6.5': {'1.3': 'ggbet'},
                      '1st map first half - fnatic total over 7.5': {'1.61': 'ggbet'},
                      '1st map first half - fnatic total over 8.5': {'2.16': 'ggbet'},
                      '1st map first half - fnatic total over 9.5': {'3.2': 'ggbet'},
                      '1st map first half - fnatic total under 6.5': {'3.32': 'ggbet'},
                      '1st map first half - fnatic total under 7.5': {'2.23': 'ggbet'},
                      '1st map first half - fnatic total under 8.5': {'1.65': 'ggbet'},
                      '1st map first half - fnatic total under 9.5': {'1.32': 'ggbet'},
                      '1st map first half - fnatic will win': {'1.61': 'ggbet'},
                      '1st map first half - godsent total over 5.5': {'1.32': 'ggbet'},
                      '1st map first half - godsent total over 6.5': {'1.65': 'ggbet'},
                      '1st map first half - godsent total over 7.5': {'2.23': 'ggbet'},
                      '1st map first half - godsent total over 8.5': {'3.32': 'ggbet'},
                      '1st map first half - godsent total under 5.5': {'3.2': 'ggbet'},
                      '1st map first half - godsent total under 6.5': {'2.16': 'ggbet'},
                      '1st map first half - godsent total under 7.5': {'1.61': 'ggbet'},
                      '1st map first half - godsent total under 8.5': {'1.3': 'ggbet'},
                      '1st map first half - godsent will win': {'2.23': 'ggbet'},
                      '1st map first half - handicap fnatic +1.5': {'1.3': 'ggbet'},
                      '1st map first half - handicap fnatic -0.5': {'1.61': 'ggbet'},
                      '1st map first half - handicap fnatic -2.5': {'2.16': 'ggbet'},
                      '1st map first half - handicap fnatic -4.5': {'3.2': 'ggbet'},
                      '1st map first half - handicap godsent +0.5': {'2.23': 'ggbet'},
                      '1st map first half - handicap godsent +2.5': {'1.65': 'ggbet'},
                      '1st map first half - handicap godsent +4.5': {'1.32': 'ggbet'},
                      '1st map first half - handicap godsent -1.5': {'3.32': 'ggbet'},
                      '1st map second half - 1x2 draw': {'9.41': 'ggbet'},
                      '1st map second half - 1x2 fnatic': {'1.7': 'ggbet'},
                      '1st map second half - 1x2 godsent': {'2.38': 'ggbet'},
                      '1st map second half - handicap fnatic +1.5': {'1.35': 'ggbet'},
                      '1st map second half - handicap fnatic -0.5': {'1.7': 'ggbet'},
                      '1st map second half - handicap fnatic -2.5': {'2.45': 'ggbet'},
                      '1st map second half - handicap fnatic -3.5': {'3.32': 'ggbet'},
                      '1st map second half - handicap godsent +0.5': {'2.08': 'ggbet'},
                      '1st map second half - handicap godsent +2.5': {'1.51': 'ggbet'},
                      '1st map second half - handicap godsent +3.5': {'1.3': 'ggbet'},
                      '1st map second half - handicap godsent -1.5': {'3.04': 'ggbet'},
                      '2-nd map: correct score 10-16': {'14.11': 'ggbet'},
                      '2-nd map: correct score 11-16': {'13.09': 'ggbet'},
                      '2-nd map: correct score 12-16': {'12.37': 'ggbet'},
                      '2-nd map: correct score 13-16': {'11.88': 'ggbet'},
                      '2-nd map: correct score 14-16': {'11.56': 'ggbet'},
                      '2-nd map: correct score 16-1': {'100': 'ggbet'},
                      '2-nd map: correct score 16-10': {'9.48': 'ggbet'},
                      '2-nd map: correct score 16-11': {'9.31': 'ggbet'},
                      '2-nd map: correct score 16-12': {'9.27': 'ggbet'},
                      '2-nd map: correct score 16-13': {'9.37': 'ggbet'},
                      '2-nd map: correct score 16-14': {'9.57': 'ggbet'},
                      '2-nd map: correct score 16-2': {'58.88': 'ggbet'},
                      '2-nd map: correct score 16-3': {'32.61': 'ggbet'},
                      '2-nd map: correct score 16-4': {'22.08': 'ggbet'},
                      '2-nd map: correct score 16-5': {'16.99': 'ggbet'},
                      '2-nd map: correct score 16-6': {'14.14': 'ggbet'},
                      '2-nd map: correct score 16-7': {'12.37': 'ggbet'},
                      '2-nd map: correct score 16-8': {'10.34': 'ggbet'},
                      '2-nd map: correct score 16-9': {'9.82': 'ggbet'},
                      '2-nd map: correct score 2-16': {'100': 'ggbet'},
                      '2-nd map: correct score 3-16': {'86.31': 'ggbet'},
                      '2-nd map: correct score 4-16': {'50.95': 'ggbet'},
                      '2-nd map: correct score 5-16': {'34.45': 'ggbet'},
                      '2-nd map: correct score 6-16': {'25.75': 'ggbet'},
                      '2-nd map: correct score 7-16': {'20.73': 'ggbet'},
                      '2-nd map: correct score 8-16': {'17.6': 'ggbet'},
                      '2-nd map: correct score 9-16': {'15.54': 'ggbet'},
                      '2-nd map: ct total  over 10.5': {'1.21': 'ggbet'},
                      '2-nd map: ct total  over 11.5': {'1.43': 'ggbet'},
                      ...
                      '2-nd map: first half correct score 10-5': {'6.21': 'ggbet'},
                      '2-nd map: first half correct score 11-4': {'8.08': 'ggbet'},
                      '2-nd map: first half correct score 12-3': {'12.11': 'ggbet'},
                      '2-nd map: first half correct score 13-2': {'20.76': 'ggbet'},
                      '2-nd map: first half correct score 14-1': {'54.33': 'ggbet'},
                      '2-nd map: first half correct score 2-13': {'45.07': 'ggbet'},
                      '2-nd map: first half correct score 3-12': {'20.29': 'ggbet'},
                      '2-nd map: first half correct score 4-11': {'12.43': 'ggbet'},
                      '2-nd map: first half correct score 5-10': {'8.41': 'ggbet'},
                      '2-nd map: first half correct score 6-9': {'6.48': 'ggbet'},
                      '2-nd map: first half correct score 7-8': {'5.41': 'ggbet'},
                      '2-nd map: first half correct score 8-7': {'5.04': 'ggbet'},
                      '2-nd map: first half correct score 9-6': {'5.27': 'ggbet'},
                      '2-nd map: fnatic total over 12.5': {'1.25': 'ggbet'},
                      '2-nd map: fnatic total over 14.5': {'1.41': 'ggbet'},
                      '2-nd map: fnatic total over 15.5': {'1.66': 'ggbet'},
                      '2-nd map: fnatic total under 12.5': {'3.7': 'ggbet'},
                      '2-nd map: fnatic total under 14.5': {'2.77': 'ggbet'},
                      '2-nd map: fnatic total under 15.5': {'2.14': 'ggbet'},
                      '2-nd map: fnatic will win': {'1.52': 'ggbet'},
                      '2-nd map: fnatic will win round 1': {'1.82': 'ggbet'},
                      '2-nd map: godsent total over 10.5': {'1.39': 'ggbet'},
                      '2-nd map: godsent total over 11.5': {'1.52': 'ggbet'},
                      '2-nd map: godsent total over 12.5': {'1.68': 'ggbet'},
                      '2-nd map: godsent total over 13.5': {'1.89': 'ggbet'},
                      '2-nd map: godsent total over 14.5': {'2.12': 'ggbet'},
                      '2-nd map: godsent total over 15.5': {'2.73': 'ggbet'},
                      '2-nd map: godsent total over 9.5': {'1.28': 'ggbet'},
                      '2-nd map: godsent total under 10.5': {'2.85': 'ggbet'},
                      '2-nd map: godsent total under 11.5': {'2.43': 'ggbet'},
                      '2-nd map: godsent total under 12.5': {'2.11': 'ggbet'},
                      '2-nd map: godsent total under 13.5': {'1.85': 'ggbet'},
                      '2-nd map: godsent total under 14.5': {'1.67': 'ggbet'},
                      '2-nd map: godsent total under 15.5': {'1.42': 'ggbet'},
                      '2-nd map: godsent total under 9.5': {'3.46': 'ggbet'},
                      '2-nd map: godsent will win': {'2.43': 'ggbet'},
                      '2-nd map: godsent will win round 1': {'1.92': 'ggbet'},
                      '2-nd map: handicap fnatic +1.5': {'1.42': 'ggbet'},
                      '2-nd map: handicap fnatic +2.5': {'1.32': 'ggbet'},
                      '2-nd map: handicap fnatic +3.5': {'1.25': 'ggbet'},
                      '2-nd map: handicap fnatic -1.5': {'1.67': 'ggbet'},
                      '2-nd map: handicap fnatic -2.5': {'1.85': 'ggbet'},
                      '2-nd map: handicap fnatic -3.5': {'2.11': 'ggbet'},
                      '2-nd map: handicap fnatic -4.5': {'2.43': 'ggbet'},
                      '2-nd map: handicap fnatic -5.5': {'2.85': 'ggbet'},
                      '2-nd map: handicap fnatic -6.5': {'3.46': 'ggbet'},
                      '2-nd map: handicap godsent +1.5': {'2.12': 'ggbet'},
                      '2-nd map: handicap godsent +2.5': {'1.89': 'ggbet'},
                      '2-nd map: handicap godsent +3.5': {'1.68': 'ggbet'},
                      '2-nd map: handicap godsent +4.5': {'1.52': 'ggbet'},
                      '2-nd map: handicap godsent +5.5': {'1.39': 'ggbet'},
                      '2-nd map: handicap godsent +6.5': {'1.28': 'ggbet'},
                      '2-nd map: handicap godsent -1.5': {'2.73': 'ggbet'},
                      '2-nd map: handicap godsent -2.5': {'3.2': 'ggbet'},
                      '2-nd map: handicap godsent -3.5': {'3.7': 'ggbet'},
                      '2-nd map: race to  rounds fnatic 12': {'1.56': 'ggbet'},
                      '2-nd map: race to  rounds fnatic 3': {'1.72': 'ggbet'},
                      '2-nd map: race to  rounds fnatic 6': {'1.64': 'ggbet'},
                      '2-nd map: race to  rounds fnatic 9': {'1.6': 'ggbet'},
                      '2-nd map: race to  rounds godsent 12': {'2.33': 'ggbet'},
                      '2-nd map: race to  rounds godsent 3': {'2.05': 'ggbet'},
                      '2-nd map: race to  rounds godsent 6': {'2.17': 'ggbet'},
                      '2-nd map: race to  rounds godsent 9': {'2.25': 'ggbet'},
                      '2-nd map: terrorist total over 10.5': {'1.21': 'ggbet'},
                      '2-nd map: terrorist total over 11.5': {'1.43': 'ggbet'},
                      ...
                      '2-nd map: will there be overtime no': {'1.08': 'ggbet'},
                      '2-nd map: will there be overtime yes': {'6.94': 'ggbet'},
                      '2nd map first half - fnatic total over 6.5': {'1.3': 'ggbet'},
                      '2nd map first half - fnatic total over 7.5': {'1.6': 'ggbet'},
                      '2nd map first half - fnatic total over 8.5': {'2.16': 'ggbet'},
                      '2nd map first half - fnatic total over 9.5': {'3.2': 'ggbet'},
                      '2nd map first half - fnatic total under 6.5': {'3.32': 'ggbet'},
                      '2nd map first half - fnatic total under 7.5': {'2.25': 'ggbet'},
                      '2nd map first half - fnatic total under 8.5': {'1.65': 'ggbet'},
                      '2nd map first half - fnatic total under 9.5': {'1.32': 'ggbet'},
                      '2nd map first half - fnatic will win': {'1.61': 'ggbet'},
                      '2nd map first half - godsent total over 5.5': {'1.32': 'ggbet'},
                      '2nd map first half - godsent total over 6.5': {'1.65': 'ggbet'},
                      '2nd map first half - godsent total over 7.5': {'2.23': 'ggbet'},
                      '2nd map first half - godsent total over 8.5': {'3.32': 'ggbet'},
                      '2nd map first half - godsent total under 5.5': {'3.2': 'ggbet'},
                      '2nd map first half - godsent total under 6.5': {'2.16': 'ggbet'},
                      '2nd map first half - godsent total under 7.5': {'1.61': 'ggbet'},
                      '2nd map first half - godsent total under 8.5': {'1.3': 'ggbet'},
                      '2nd map first half - godsent will win': {'2.23': 'ggbet'},
                      '2nd map first half - handicap fnatic +1.5': {'1.3': 'ggbet'},
                      '2nd map first half - handicap fnatic -0.5': {'1.61': 'ggbet'},
                      '2nd map first half - handicap fnatic -2.5': {'2.16': 'ggbet'},
                      '2nd map first half - handicap fnatic -4.5': {'3.2': 'ggbet'},
                      '2nd map first half - handicap godsent +0.5': {'2.23': 'ggbet'},
                      '2nd map first half - handicap godsent +2.5': {'1.65': 'ggbet'},
                      '2nd map first half - handicap godsent +4.5': {'1.32': 'ggbet'},
                      '2nd map first half - handicap godsent -1.5': {'3.32': 'ggbet'},
                      '2nd map second half - 1x2 draw': {'9.41': 'ggbet'},
                      '2nd map second half - 1x2 fnatic': {'1.7': 'ggbet'},
                      '2nd map second half - 1x2 godsent': {'2.39': 'ggbet'},
                      '2nd map second half - handicap fnatic +1.5': {'1.35': 'ggbet'},
                      '2nd map second half - handicap fnatic -0.5': {'1.7': 'ggbet'},
                      '2nd map second half - handicap fnatic -2.5': {'2.45': 'ggbet'},
                      '2nd map second half - handicap fnatic -3.5': {'3.32': 'ggbet'},
                      '2nd map second half - handicap godsent +0.5': {'2.08': 'ggbet'},
                      '2nd map second half - handicap godsent +2.5': {'1.51': 'ggbet'},
                      '2nd map second half - handicap godsent +3.5': {'1.3': 'ggbet'},
                      '2nd map second half - handicap godsent -1.5': {'3.04': 'ggbet'},
                      'correct score 0-2': {'5.4': 'ggbet'},
                      'correct score 1-2': {'4.81': 'ggbet'},
                      'correct score 2-0': {'2.29': 'ggbet'},
                      'correct score 2-1': {'3.2': 'ggbet'},
                      'fnatic handicap +1.5 maps': {'1.13': 'ggbet'},
                      'fnatic handicap -1.5 maps': {'2.29': 'ggbet'},
                      'fnatic total over 32.5': {'1.83': 'ggbet'},
                      'fnatic total over 37.5': {'2.31': 'ggbet'},
                      'fnatic total over 41.5': {'3.32': 'ggbet'},
                      'fnatic total under 32.5': {'1.91': 'ggbet'},
                      'fnatic total under 37.5': {'1.57': 'ggbet'},
                      'fnatic total under 41.5': {'1.3': 'ggbet'},
                      'fnatic will win': {'1.41': 'ggbet'},
                      'godsent handicap +1.5 maps': {'1.58': 'ggbet'},
                      'godsent handicap -1.5 maps': {'5.4': 'ggbet'},
                      'godsent total over 21.5': {'1.23': 'ggbet'},
                      'godsent total over 25.5': {'1.42': 'ggbet'},
                      'godsent total over 32.5': {'2.09': 'ggbet'},
                      'godsent total over 36.5': {'2.7': 'ggbet'},
                      'godsent total over 40.5': {'3.99': 'ggbet'},
                      'godsent total under 21.5': {'3.89': 'ggbet'},
                      'godsent total under 25.5': {'2.73': 'ggbet'},
                      'godsent total under 32.5': {'1.69': 'ggbet'},
                      'godsent total under 36.5': {'1.43': 'ggbet'},
                      'godsent total under 40.5': {'1.22': 'ggbet'},
                      'godsent will win': {'2.81': 'ggbet'},
                      'handicap fnatic +0.5': {'1.38': 'ggbet'},
                      'handicap fnatic +3.5': {'1.29': 'ggbet'},
                      'handicap fnatic -10.5': {'2.94': 'ggbet'},
                      'handicap fnatic -12.5': {'3.99': 'ggbet'},
                      'handicap fnatic -2.5': {'1.5': 'ggbet'},
                      'handicap fnatic -4.5': {'1.63': 'ggbet'},
                      'handicap fnatic -6.5': {'1.88': 'ggbet'},
                      'handicap fnatic -8.5': {'2.27': 'ggbet'},
                      'handicap godsent +10.5': {'1.37': 'ggbet'},
                      'handicap godsent +12.5': {'1.22': 'ggbet'},
                      'handicap godsent +2.5': {'2.48': 'ggbet'},
                      'handicap godsent +4.5': {'2.19': 'ggbet'},
                      'handicap godsent +6.5': {'1.86': 'ggbet'},
                      'handicap godsent +8.5': {'1.59': 'ggbet'},
                      'handicap godsent -0.5': {'2.9': 'ggbet'},
                      'handicap godsent -3.5': {'3.39': 'ggbet'},
                      'odd/even maps even': {'1.72': 'ggbet'},
                      'odd/even maps odd': {'2.05': 'ggbet'},
                      'total maps over 2.5': {'2.05': 'ggbet'},
                      'total maps under 2.5': {'1.72': 'ggbet'},
                      'total over 51.5': {'1.2': 'ggbet'},
                      'total over 53.5': {'1.33': 'ggbet'},
                      'total over 55.5': {'1.47': 'ggbet'},
                      'total over 57.5': {'1.61': 'ggbet'},
                      'total over 60.5': {'1.77': 'ggbet'},
                      'total over 66.5': {'1.97': 'ggbet'},
                      'total over 72.5': {'2.23': 'ggbet'},
                      'total over 75.5': {'2.51': 'ggbet'},
                      'total over 78.5': {'3.04': 'ggbet'},
                      'total over 80.5': {'3.62': 'ggbet'},
                      'total under 51.5': {'4.23': 'ggbet'},
                      'total under 53.5': {'3.14': 'ggbet'},
                      'total under 55.5': {'2.57': 'ggbet'},
                      'total under 57.5': {'2.23': 'ggbet'},
                      'total under 60.5': {'1.98': 'ggbet'},
                      'total under 66.5': {'1.78': 'ggbet'},
                      'total under 72.5': {'1.61': 'ggbet'},
                      'total under 75.5': {'1.49': 'ggbet'},
                      'total under 78.5': {'1.35': 'ggbet'},
                      'total under 80.5': {'1.26': 'ggbet'}},
 'forze - nordavind': {'1-st map: forze will win': {'1.56': 'ggbet'},
                       '1-st map: forze will win round 1': {'1.82': 'ggbet'},
                       '1-st map: handicap forze +1.5': {'1.46': 'ggbet'},
                       '1-st map: handicap forze -1.5': {'1.71': 'ggbet'},
                       '1-st map: handicap forze -2.5': {'1.89': 'ggbet'},
                       '1-st map: handicap forze -3.5': {'2.12': 'ggbet'},
                       '1-st map: handicap forze -4.5': {'2.43': 'ggbet'},
                       '1-st map: handicap nordavind +1.5': {'2.06': 'ggbet'},
                       '1-st map: handicap nordavind +2.5': {'1.85': 'ggbet'},
                       '1-st map: handicap nordavind +3.5': {'1.67': 'ggbet'},
                       '1-st map: handicap nordavind +4.5': {'1.52': 'ggbet'},
                       '1-st map: handicap nordavind -1.5': {'2.6': 'ggbet'},
                       '1-st map: nordavind will win': {'2.33': 'ggbet'},
                       '1-st map: nordavind will win round 1': {'1.92': 'ggbet'},
                       ...
                       '2-nd map: forze will win': {'1.55': 'ggbet'},
                       '2-nd map: forze will win round 1': {'1.82': 'ggbet'},
                       '2-nd map: handicap forze +1.5': {'1.45': 'ggbet'},
                       '2-nd map: handicap forze -1.5': {'1.7': 'ggbet'},
                       '2-nd map: handicap forze -2.5': {'1.87': 'ggbet'},
                       '2-nd map: handicap forze -3.5': {'2.11': 'ggbet'},
                       '2-nd map: handicap forze -4.5': {'2.4': 'ggbet'},
                       '2-nd map: handicap nordavind +1.5': {'2.08': 'ggbet'},
                       '2-nd map: handicap nordavind +2.5': {'1.87': 'ggbet'},
                       '2-nd map: handicap nordavind +3.5': {'1.68': 'ggbet'},
                       '2-nd map: handicap nordavind +4.5': {'1.53': 'ggbet'},
                       '2-nd map: handicap nordavind -1.5': {'2.63': 'ggbet'},
                       '2-nd map: nordavind will win': {'2.35': 'ggbet'},
                       '2-nd map: nordavind will win round 1': {'1.92': 'ggbet'},
                       ...
                       'correct score 0-2': {'4.6': 'ggbet'},
                       'correct score 1-2': {'4.74': 'ggbet'},
                       'correct score 2-0': {'2.32': 'ggbet'},
                       'correct score 2-1': {'3.53': 'ggbet'},
                       'forze handicap +1.5 maps': {'1.17': 'ggbet'},
                       'forze handicap -1.5 maps': {'2.33': 'ggbet'},
                       'forze will win': {'1.49': 'ggbet'},
                       'nordavind handicap +1.5 maps': {'1.56': 'ggbet'},
                       'nordavind handicap -1.5 maps': {'4.64': 'ggbet'},
                       'nordavind will win': {'2.54': 'ggbet'},
                       'odd/even maps even': {'1.64': 'ggbet'},
                       'odd/even maps odd': {'2.17': 'ggbet'},
                       'total maps over 2.5': {'2.17': 'ggbet'},
                       'total maps under 2.5': {'1.64': 'ggbet'}},
 'global - knockturnal': {'1-st map: global will win': {'1.1': 'ggbet'},
                          '1-st map: knockturnal will win': {'6.21': 'ggbet'},
                          'global will win': {'1.1': 'ggbet'},
                          'knockturnal will win': {'6.41': 'ggbet'}},
 'gobananas - royalty': {'1-st map: gobananas will win': {'1.5': 'ggbet'},
                         '1-st map: royalty will win': {'2.48': 'ggbet'},
                         'gobananas will win': {'1.51': 'ggbet'},
                         'royalty will win': {'2.48': 'ggbet'}},
 'grazur - lethal divide': {'1-st map: grazur will win': {'2.31': 'ggbet'},
                            '1-st map: lethal divide will win': {'1.57': 'ggbet'},
                            '2-nd map: grazur will win': {'2.33': 'ggbet'},
                            '2-nd map: lethal divide will win': {'1.56': 'ggbet'},
                            'grazur will win': {'2.51': 'ggbet'},
                            'lethal divide will win': {'1.5': 'ggbet'}},
 'ground zero - rooster': {'1-st map: ground zero will win': {'2.38': 'ggbet'},
 ...
 'hard legion - havu': {'1-st map: handicap hard legion +1.5': {'1.91': 'ggbet'},
                        '1-st map: handicap hard legion +2.5': {'1.72': 'ggbet'},
                        '1-st map: handicap hard legion +3.5': {'1.57': 'ggbet'},
                        '1-st map: handicap hard legion +4.5': {'1.44': 'ggbet'},
                        '1-st map: handicap hard legion +5.5': {'1.33': 'ggbet'},
                        '1-st map: handicap hard legion -1.5': {'2.38': 'ggbet'},
                        '1-st map: handicap hard legion -2.5': {'2.66': 'ggbet'},
                        '1-st map: handicap hard legion -3.5': {'3.09': 'ggbet'},
                        '1-st map: handicap havu +1.5': {'1.54': 'ggbet'},
                        '1-st map: handicap havu +2.5': {'1.44': 'ggbet'},
                        '1-st map: handicap havu +3.5': {'1.34': 'ggbet'},
                        '1-st map: handicap havu -1.5': {'1.83': 'ggbet'},
                        '1-st map: handicap havu -2.5': {'2.05': 'ggbet'},
                        '1-st map: handicap havu -3.5': {'2.31': 'ggbet'},
                        '1-st map: handicap havu -4.5': {'2.66': 'ggbet'},
                        '1-st map: handicap havu -5.5': {'3.14': 'ggbet'},
                        '1-st map: hard legion will win': {'2.12': 'ggbet'},
                        '1-st map: hard legion will win round 1': {'1.9': 'ggbet'},
                        '1-st map: havu will win': {'1.67': 'ggbet'},
                        '1-st map: havu will win round 1': {'1.84': 'ggbet'},
                        '1-st map: total over 24.5': {'1.35': 'ggbet'},
                        ...
                        '1-st map: total under 27.5': {'1.62': 'ggbet'},
                        '1-st map: total under 28.5': {'1.39': 'ggbet'},
                        '2-nd map: handicap hard legion +1.5': {'1.91': 'ggbet'},
                        '2-nd map: handicap hard legion +2.5': {'1.73': 'ggbet'},
                        '2-nd map: handicap hard legion +3.5': {'1.57': 'ggbet'},
                        '2-nd map: handicap hard legion +4.5': {'1.45': 'ggbet'},
                        '2-nd map: handicap hard legion +5.5': {'1.34': 'ggbet'},
                        '2-nd map: handicap hard legion -1.5': {'2.35': 'ggbet'},
                        '2-nd map: handicap hard legion -2.5': {'2.66': 'ggbet'},
                        '2-nd map: handicap hard legion -3.5': {'3.09': 'ggbet'},
                        '2-nd map: handicap havu +1.5': {'1.55': 'ggbet'},
                        '2-nd map: handicap havu +2.5': {'1.44': 'ggbet'},
                        '2-nd map: handicap havu +3.5': {'1.34': 'ggbet'},
                        '2-nd map: handicap havu -1.5': {'1.83': 'ggbet'},
                        '2-nd map: handicap havu -2.5': {'2.03': 'ggbet'},
                        '2-nd map: handicap havu -3.5': {'2.31': 'ggbet'},
                        '2-nd map: handicap havu -4.5': {'2.63': 'ggbet'},
                        '2-nd map: handicap havu -5.5': {'3.09': 'ggbet'},
                        '2-nd map: hard legion will win': {'2.12': 'ggbet'},
                        '2-nd map: hard legion will win round 1': {'1.9': 'ggbet'},
                        '2-nd map: havu will win': {'1.67': 'ggbet'},
                        '2-nd map: havu will win round 1': {'1.84': 'ggbet'},
                        '2-nd map: total over 24.5': {'1.36': 'ggbet'},
                        '2-nd map: total over 25.5': {'1.54': 'ggbet'},
                        '2-nd map: total over 26.5': {'1.81': 'ggbet'},
                        '2-nd map: total over 27.5': {'2.21': 'ggbet'},
                        ...
                        '2-nd map: total under 27.5': {'1.62': 'ggbet'},
                        '2-nd map: total under 28.5': {'1.39': 'ggbet'},
                        'correct score 0-2': {'2.61': 'ggbet'},
                        'correct score 1-2': {'3.64': 'ggbet'},
                        'correct score 2-0': {'3.96': 'ggbet'},
                        'correct score 2-1': {'4.33': 'ggbet'},
                        'hard legion handicap +1.5 maps': {'1.45': 'ggbet'},
                        'hard legion handicap -1.5 maps': {'3.99': 'ggbet'},
                        'hard legion will win': {'2.23': 'ggbet'},
                        'havu handicap +1.5 maps': {'1.22': 'ggbet'},
                        'havu handicap -1.5 maps': {'2.63': 'ggbet'},
                        'havu will win': {'1.62': 'ggbet'},
                        'odd/even maps even': {'1.68': 'ggbet'},
                        'odd/even maps odd': {'2.11': 'ggbet'},
                        'total maps over 2.5': {'2.11': 'ggbet'},
                        'total maps under 2.5': {'1.68': 'ggbet'}},
 'hellraisers - syman': {'1-st map: correct score 10t-e': {'12.25': 'ggbet'},
 ...
 'heroic - og': {'1-st map: correct score 1-16': {'100': 'ggbet'},
                 '1-st map: correct score 10-16': {'12.05': 'ggbet'},
                 '1-st map: correct score 11-16': {'11.43': 'ggbet'},
                 '1-st map: correct score 12-16': {'10.21': 'ggbet'},
                 '1-st map: correct score 13-16': {'10.06': 'ggbet'},
                 '1-st map: correct score 14-16': {'10.01': 'ggbet'},
                 '1-st map: correct score 16-1': {'100': 'ggbet'},
                 '1-st map: correct score 16-10': {'10.35': 'ggbet'},
                 '1-st map: correct score 16-11': {'10.02': 'ggbet'},
                 '1-st map: correct score 16-12': {'9.82': 'ggbet'},
                 '1-st map: correct score 16-13': {'9.75': 'ggbet'},
                 '1-st map: correct score 16-14': {'9.78': 'ggbet'},
                 '1-st map: correct score 16-2': {'86.57': 'ggbet'},
                 '1-st map: correct score 16-3': {'45.52': 'ggbet'},
                 '1-st map: correct score 16-4': {'29.18': 'ggbet'},
                 '1-st map: correct score 16-5': {'21.43': 'ggbet'},
                 '1-st map: correct score 16-6': {'17.23': 'ggbet'},
                 '1-st map: correct score 16-7': {'14.71': 'ggbet'},
                 '1-st map: correct score 16-8': {'13.07': 'ggbet'},
                 '1-st map: correct score 16-9': {'11.97': 'ggbet'},
                 '1-st map: correct score 2-16': {'100': 'ggbet'},
                 '1-st map: correct score 3-16': {'53.41': 'ggbet'},
                 '1-st map: correct score 4-16': {'33.71': 'ggbet'},
                 '1-st map: correct score 5-16': {'24.31': 'ggbet'},
                 '1-st map: correct score 6-16': {'19.24': 'ggbet'},
                 '1-st map: correct score 7-16': {'16.21': 'ggbet'},
                 '1-st map: correct score 8-16': {'14.27': 'ggbet'},
                 '1-st map: correct score 9-16': {'12.95': 'ggbet'},
                 '1-st map: ct total  over 10.5': {'1.21': 'ggbet'},
                 '1-st map: ct total  over 11.5': {'1.43': 'ggbet'},
                 '1-st map: ct total  over 13.5': {'2.08': 'ggbet'},
                 '1-st map: ct total  over 15.5': {'3.54': 'ggbet'},
                 ...
                 '1-st map: ct total  under 13.5': {'1.7': 'ggbet'},
                 '1-st map: ct total  under 15.5': {'1.27': 'ggbet'},
                 '1-st map: first half correct score 1-14': {'94.5': 'ggbet'},
                 '1-st map: first half correct score 10-5': {'6.94': 'ggbet'},
                 '1-st map: first half correct score 11-4': {'9.16': 'ggbet'},
                 '1-st map: first half correct score 12-3': {'14.35': 'ggbet'},
                 '1-st map: first half correct score 13-2': {'26.47': 'ggbet'},
                 '1-st map: first half correct score 14-1': {'76.79': 'ggbet'},
                 '1-st map: first half correct score 2-13': {'30.8': 'ggbet'},
                 '1-st map: first half correct score 3-12': {'15.88': 'ggbet'},
                 '1-st map: first half correct score 4-11': {'9.78': 'ggbet'},
                 '1-st map: first half correct score 5-10': {'7.39': 'ggbet'},
                 '1-st map: first half correct score 6-9': {'5.9': 'ggbet'},
                 '1-st map: first half correct score 7-8': {'5.2': 'ggbet'},
                 '1-st map: first half correct score 8-7': {'5.12': 'ggbet'},
                 '1-st map: first half correct score 9-6': {'5.65': 'ggbet'},
                 '1-st map: handicap heroic +1.5': {'1.63': 'ggbet'},
                 '1-st map: handicap heroic +2.5': {'1.49': 'ggbet'},
                 '1-st map: handicap heroic +3.5': {'1.38': 'ggbet'},
                 '1-st map: handicap heroic +4.5': {'1.29': 'ggbet'},
                 '1-st map: handicap heroic +5.5': {'1.21': 'ggbet'},
                 '1-st map: handicap heroic -1.5': {'1.98': 'ggbet'},
                 '1-st map: handicap heroic -2.5': {'2.25': 'ggbet'},
                 '1-st map: handicap heroic -3.5': {'2.57': 'ggbet'},
                 '1-st map: handicap heroic -4.5': {'3.04': 'ggbet'},
                 '1-st map: handicap heroic -5.5': {'3.62': 'ggbet'},
                 '1-st map: handicap og +1.5': {'1.77': 'ggbet'},
                 '1-st map: handicap og +2.5': {'1.6': 'ggbet'},
                 '1-st map: handicap og +3.5': {'1.47': 'ggbet'},
                 '1-st map: handicap og +4.5': {'1.35': 'ggbet'},
                 '1-st map: handicap og +5.5': {'1.26': 'ggbet'},
                 '1-st map: handicap og -1.5': {'2.19': 'ggbet'},
                 '1-st map: handicap og -2.5': {'2.51': 'ggbet'},
                 '1-st map: handicap og -3.5': {'2.9': 'ggbet'},
                 '1-st map: handicap og -4.5': {'3.39': 'ggbet'},
                 '1-st map: handicap og -5.5': {'4.11': 'ggbet'},
                 '1-st map: heroic total over 10.5': {'1.21': 'ggbet'},
                 '1-st map: heroic total over 12.5': {'1.38': 'ggbet'},
                 '1-st map: heroic total over 13.5': {'1.49': 'ggbet'},
                 '1-st map: heroic total over 14.5': {'1.63': 'ggbet'},
                 '1-st map: heroic total over 15.5': {'1.98': 'ggbet'},
                 '1-st map: heroic total under 10.5': {'4.11': 'ggbet'},
                 '1-st map: heroic total under 12.5': {'2.9': 'ggbet'},
                 '1-st map: heroic total under 13.5': {'2.51': 'ggbet'},
                 '1-st map: heroic total under 14.5': {'2.19': 'ggbet'},
                 '1-st map: heroic total under 15.5': {'1.77': 'ggbet'},
                 '1-st map: heroic will win': {'1.78': 'ggbet'},
                 '1-st map: heroic will win round 1': {'1.86': 'ggbet'},
                 '1-st map: og total over 10.5': {'1.26': 'ggbet'},
                 '1-st map: og total over 11.5': {'1.35': 'ggbet'},
                 '1-st map: og total over 12.5': {'1.47': 'ggbet'},
                 '1-st map: og total over 13.5': {'1.6': 'ggbet'},
                 '1-st map: og total over 14.5': {'1.77': 'ggbet'},
                 '1-st map: og total over 15.5': {'2.19': 'ggbet'},
                 '1-st map: og total under 10.5': {'3.62': 'ggbet'},
                 '1-st map: og total under 11.5': {'3.04': 'ggbet'},
                 '1-st map: og total under 12.5': {'2.57': 'ggbet'},
                 '1-st map: og total under 13.5': {'2.25': 'ggbet'},
                 '1-st map: og total under 14.5': {'1.98': 'ggbet'},
                 '1-st map: og total under 15.5': {'1.63': 'ggbet'},
                 '1-st map: og will win': {'1.97': 'ggbet'},
                 '1-st map: og will win round 1': {'1.88': 'ggbet'},
                 '1-st map: race to  rounds heroic 12': {'1.8': 'ggbet'},
                 '1-st map: race to  rounds heroic 3': {'1.84': 'ggbet'},
                 '1-st map: race to  rounds heroic 6': {'1.82': 'ggbet'},
                 '1-st map: race to  rounds heroic 9': {'1.81': 'ggbet'},
                 '1-st map: race to  rounds og 12': {'1.94': 'ggbet'},
                 '1-st map: race to  rounds og 3': {'1.9': 'ggbet'},
                 '1-st map: race to  rounds og 6': {'1.92': 'ggbet'},
                 '1-st map: race to  rounds og 9': {'1.93': 'ggbet'},
                 '1-st map: terrorist total over 10.5': {'1.21': 'ggbet'},
                 '1-st map: terrorist total over 11.5': {'1.43': 'ggbet'},
                 '1-st map: terrorist total over 13.5': {'2.08': 'ggbet'},
                 '1-st map: terrorist total over 15.5': {'3.54': 'ggbet'},
                 ...
                 '1-st map: will there be overtime no': {'1.09': 'ggbet'},
                 '1-st map: will there be overtime yes': {'6.55': 'ggbet'},
                 '1st map first half - handicap heroic +1.5': {'1.42': 'ggbet'},
                 '1st map first half - handicap heroic -0.5': {'1.81': 'ggbet'},
                 '1st map first half - handicap heroic -2.5': {'2.51': 'ggbet'},
                 '1st map first half - handicap heroic -4.5': {'3.89': 'ggbet'},
                 '1st map first half - handicap og +0.5': {'1.93': 'ggbet'},
                 '1st map first half - handicap og +2.5': {'1.49': 'ggbet'},
                 '1st map first half - handicap og +4.5': {'1.23': 'ggbet'},
                 '1st map first half - handicap og -1.5': {'2.73': 'ggbet'},
                 '1st map first half - heroic total over 6.5': {'1.42': 'ggbet'},
                 '1st map first half - heroic total over 7.5': {'1.81': 'ggbet'},
                 '1st map first half - heroic total over 8.5': {'2.51': 'ggbet'},
                 '1st map first half - heroic total over 9.5': {'3.89': 'ggbet'},
                 '1st map first half - heroic total under 6.5': {'2.73': 'ggbet'},
                 '1st map first half - heroic total under 7.5': {'1.93': 'ggbet'},
                 '1st map first half - heroic total under 8.5': {'1.49': 'ggbet'},
                 '1st map first half - heroic total under 9.5': {'1.23': 'ggbet'},
                 '1st map first half - heroic will win': {'1.81': 'ggbet'},
                 '1st map first half - og total over 5.5': {'1.23': 'ggbet'},
                 '1st map first half - og total over 6.5': {'1.49': 'ggbet'},
                 '1st map first half - og total over 7.5': {'1.93': 'ggbet'},
                 '1st map first half - og total over 8.5': {'2.73': 'ggbet'},
                 '1st map first half - og total under 5.5': {'3.89': 'ggbet'},
                 '1st map first half - og total under 6.5': {'2.51': 'ggbet'},
                 '1st map first half - og total under 7.5': {'1.81': 'ggbet'},
                 '1st map first half - og total under 8.5': {'1.42': 'ggbet'},
                 '1st map first half - og will win': {'1.93': 'ggbet'},
                 '1st map second half - 1x2 draw': {'9.45': 'ggbet'},
                 '1st map second half - 1x2 heroic': {'1.92': 'ggbet'},
                 '1st map second half - 1x2 og': {'2.05': 'ggbet'},
                 '1st map second half - handicap heroic +0.5': {'1.72': 'ggbet'},
                 '1st map second half - handicap heroic +2.5': {'1.35': 'ggbet'},
                 '1st map second half - handicap heroic -1.5': {'2.38': 'ggbet'},
                 '1st map second half - handicap heroic -3.5': {'3.79': 'ggbet'},
                 '1st map second half - handicap og +1.5': {'1.54': 'ggbet'},
                 '1st map second half - handicap og +3.5': {'1.24': 'ggbet'},
                 '1st map second half - handicap og -0.5': {'2.05': 'ggbet'},
                 '1st map second half - handicap og -2.5': {'3.04': 'ggbet'},
                 '2-nd map: correct score 1-16': {'100': 'ggbet'},
                 '2-nd map: correct score 10-16': {'12.05': 'ggbet'},
                 '2-nd map: correct score 11-16': {'11.44': 'ggbet'},
                 '2-nd map: correct score 12-16': {'10.22': 'ggbet'},
                 '2-nd map: correct score 13-16': {'10.07': 'ggbet'},
                 '2-nd map: correct score 14-16': {'10.02': 'ggbet'},
                 '2-nd map: correct score 16-1': {'100': 'ggbet'},
                 '2-nd map: correct score 16-10': {'10.35': 'ggbet'},
                 '2-nd map: correct score 16-11': {'10.03': 'ggbet'},
                 '2-nd map: correct score 16-12': {'9.83': 'ggbet'},
                 '2-nd map: correct score 16-13': {'9.76': 'ggbet'},
                 '2-nd map: correct score 16-14': {'9.79': 'ggbet'},
                 '2-nd map: correct score 16-2': {'86.44': 'ggbet'},
                 '2-nd map: correct score 16-3': {'45.47': 'ggbet'},
                 '2-nd map: correct score 16-4': {'29.16': 'ggbet'},
                 '2-nd map: correct score 16-5': {'21.42': 'ggbet'},
                 '2-nd map: correct score 16-6': {'17.23': 'ggbet'},
                 '2-nd map: correct score 16-7': {'14.71': 'ggbet'},
                 '2-nd map: correct score 16-8': {'13.07': 'ggbet'},
                 '2-nd map: correct score 16-9': {'11.97': 'ggbet'},
                 '2-nd map: correct score 2-16': {'100': 'ggbet'},
                 '2-nd map: correct score 3-16': {'53.37': 'ggbet'},
                 '2-nd map: correct score 4-16': {'33.69': 'ggbet'},
                 '2-nd map: correct score 5-16': {'24.3': 'ggbet'},
                 '2-nd map: correct score 6-16': {'19.23': 'ggbet'},
                 '2-nd map: correct score 7-16': {'16.22': 'ggbet'},
                 '2-nd map: correct score 8-16': {'14.27': 'ggbet'},
                 '2-nd map: correct score 9-16': {'12.96': 'ggbet'},
                 '2-nd map: ct total  over 10.5': {'1.21': 'ggbet'},
                 '2-nd map: ct total  over 11.5': {'1.43': 'ggbet'},
                 '2-nd map: ct total  over 13.5': {'2.08': 'ggbet'},
                 '2-nd map: ct total  over 15.5': {'3.54': 'ggbet'},
                 ...
                 '2-nd map: ct total  under 13.5': {'1.7': 'ggbet'},
                 '2-nd map: ct total  under 15.5': {'1.27': 'ggbet'},
                 '2-nd map: first half correct score 1-14': {'94.45': 'ggbet'},
                 '2-nd map: first half correct score 10-5': {'6.95': 'ggbet'},
                 '2-nd map: first half correct score 11-4': {'9.17': 'ggbet'},
                 '2-nd map: first half correct score 12-3': {'14.35': 'ggbet'},
                 '2-nd map: first half correct score 13-2': {'26.46': 'ggbet'},
                 '2-nd map: first half correct score 14-1': {'76.73': 'ggbet'},
                 '2-nd map: first half correct score 2-13': {'30.79': 'ggbet'},
                 '2-nd map: first half correct score 3-12': {'15.88': 'ggbet'},
                 '2-nd map: first half correct score 4-11': {'9.79': 'ggbet'},
                 '2-nd map: first half correct score 5-10': {'7.4': 'ggbet'},
                 '2-nd map: first half correct score 6-9': {'5.91': 'ggbet'},
                 '2-nd map: first half correct score 7-8': {'5.2': 'ggbet'},
                 '2-nd map: first half correct score 8-7': {'5.12': 'ggbet'},
                 '2-nd map: first half correct score 9-6': {'5.66': 'ggbet'},
                 '2-nd map: handicap heroic +1.5': {'1.63': 'ggbet'},
                 '2-nd map: handicap heroic +2.5': {'1.49': 'ggbet'},
                 '2-nd map: handicap heroic +3.5': {'1.38': 'ggbet'},
                 '2-nd map: handicap heroic +4.5': {'1.29': 'ggbet'},
                 '2-nd map: handicap heroic +5.5': {'1.21': 'ggbet'},
                 '2-nd map: handicap heroic -1.5': {'1.99': 'ggbet'},
                 '2-nd map: handicap heroic -2.5': {'2.25': 'ggbet'},
                 '2-nd map: handicap heroic -3.5': {'2.57': 'ggbet'},
                 '2-nd map: handicap heroic -4.5': {'3.04': 'ggbet'},
                 '2-nd map: handicap heroic -5.5': {'3.62': 'ggbet'},
                 '2-nd map: handicap og +1.5': {'1.76': 'ggbet'},
                 '2-nd map: handicap og +2.5': {'1.6': 'ggbet'},
                 '2-nd map: handicap og +3.5': {'1.47': 'ggbet'},
                 '2-nd map: handicap og +4.5': {'1.35': 'ggbet'},
                 '2-nd map: handicap og +5.5': {'1.26': 'ggbet'},
                 '2-nd map: handicap og -1.5': {'2.19': 'ggbet'},
                 '2-nd map: handicap og -2.5': {'2.51': 'ggbet'},
                 '2-nd map: handicap og -3.5': {'2.9': 'ggbet'},
                 '2-nd map: handicap og -4.5': {'3.39': 'ggbet'},
                 '2-nd map: handicap og -5.5': {'4.11': 'ggbet'},
                 '2-nd map: heroic total over 10.5': {'1.21': 'ggbet'},
                 '2-nd map: heroic total over 12.5': {'1.38': 'ggbet'},
                 '2-nd map: heroic total over 13.5': {'1.49': 'ggbet'},
                 '2-nd map: heroic total over 14.5': {'1.62': 'ggbet'},
                 '2-nd map: heroic total over 15.5': {'1.98': 'ggbet'},
                 '2-nd map: heroic total under 10.5': {'4.11': 'ggbet'},
                 '2-nd map: heroic total under 12.5': {'2.9': 'ggbet'},
                 '2-nd map: heroic total under 13.5': {'2.51': 'ggbet'},
                 '2-nd map: heroic total under 14.5': {'2.21': 'ggbet'},
                 '2-nd map: heroic total under 15.5': {'1.77': 'ggbet'},
                 '2-nd map: heroic will win': {'1.79': 'ggbet'},
                 '2-nd map: heroic will win round 1': {'1.86': 'ggbet'},
                 '2-nd map: og total over 10.5': {'1.26': 'ggbet'},
                 '2-nd map: og total over 11.5': {'1.35': 'ggbet'},
                 '2-nd map: og total over 12.5': {'1.47': 'ggbet'},
                 '2-nd map: og total over 13.5': {'1.6': 'ggbet'},
                 '2-nd map: og total over 14.5': {'1.76': 'ggbet'},
                 '2-nd map: og total over 15.5': {'2.19': 'ggbet'},
                 '2-nd map: og total under 10.5': {'3.62': 'ggbet'},
                 '2-nd map: og total under 11.5': {'3.04': 'ggbet'},
                 '2-nd map: og total under 12.5': {'2.57': 'ggbet'},
                 '2-nd map: og total under 13.5': {'2.25': 'ggbet'},
                 '2-nd map: og total under 14.5': {'1.99': 'ggbet'},
                 '2-nd map: og total under 15.5': {'1.63': 'ggbet'},
                 '2-nd map: og will win': {'1.96': 'ggbet'},
                 '2-nd map: og will win round 1': {'1.88': 'ggbet'},
                 '2-nd map: race to  rounds heroic 12': {'1.8': 'ggbet'},
                 '2-nd map: race to  rounds heroic 3': {'1.84': 'ggbet'},
                 '2-nd map: race to  rounds heroic 6': {'1.82': 'ggbet'},
                 '2-nd map: race to  rounds heroic 9': {'1.81': 'ggbet'},
                 '2-nd map: race to  rounds og 12': {'1.94': 'ggbet'},
                 '2-nd map: race to  rounds og 3': {'1.9': 'ggbet'},
                 '2-nd map: race to  rounds og 6': {'1.92': 'ggbet'},
                 '2-nd map: race to  rounds og 9': {'1.93': 'ggbet'},
                 '2-nd map: terrorist total over 10.5': {'1.21': 'ggbet'},
                 '2-nd map: terrorist total over 11.5': {'1.43': 'ggbet'},
                 '2-nd map: terrorist total over 13.5': {'2.08': 'ggbet'},
                 '2-nd map: terrorist total over 15.5': {'3.54': 'ggbet'},
                 ...
                 '2-nd map: will there be overtime no': {'1.09': 'ggbet'},
                 '2-nd map: will there be overtime yes': {'6.55': 'ggbet'},
                 '2nd map first half - handicap heroic +1.5': {'1.42': 'ggbet'},
                 '2nd map first half - handicap heroic -0.5': {'1.81': 'ggbet'},
                 '2nd map first half - handicap heroic -2.5': {'2.54': 'ggbet'},
                 '2nd map first half - handicap heroic -4.5': {'3.89': 'ggbet'},
                 '2nd map first half - handicap og +0.5': {'1.93': 'ggbet'},
                 '2nd map first half - handicap og +2.5': {'1.48': 'ggbet'},
                 '2nd map first half - handicap og +4.5': {'1.23': 'ggbet'},
                 '2nd map first half - handicap og -1.5': {'2.73': 'ggbet'},
                 '2nd map first half - heroic total over 6.5': {'1.41': 'ggbet'},
                 '2nd map first half - heroic total over 7.5': {'1.81': 'ggbet'},
                 '2nd map first half - heroic total over 8.5': {'2.51': 'ggbet'},
                 '2nd map first half - heroic total over 9.5': {'3.79': 'ggbet'},
                 '2nd map first half - heroic total under 6.5': {'2.77': 'ggbet'},
                 '2nd map first half - heroic total under 7.5': {'1.93': 'ggbet'},
                 '2nd map first half - heroic total under 8.5': {'1.49': 'ggbet'},
                 '2nd map first half - heroic total under 9.5': {'1.24': 'ggbet'},
                 '2nd map first half - heroic will win': {'1.81': 'ggbet'},
                 '2nd map first half - og total over 5.5': {'1.23': 'ggbet'},
                 '2nd map first half - og total over 6.5': {'1.48': 'ggbet'},
                 '2nd map first half - og total over 7.5': {'1.93': 'ggbet'},
                 '2nd map first half - og total over 8.5': {'2.73': 'ggbet'},
                 '2nd map first half - og total under 5.5': {'3.89': 'ggbet'},
                 '2nd map first half - og total under 6.5': {'2.54': 'ggbet'},
                 '2nd map first half - og total under 7.5': {'1.81': 'ggbet'},
                 '2nd map first half - og total under 8.5': {'1.42': 'ggbet'},
                 '2nd map first half - og will win': {'1.93': 'ggbet'},
                 '2nd map second half - 1x2 draw': {'9.45': 'ggbet'},
                 '2nd map second half - 1x2 heroic': {'1.92': 'ggbet'},
                 '2nd map second half - 1x2 og': {'2.05': 'ggbet'},
                 '2nd map second half - handicap heroic +0.5': {'1.72': 'ggbet'},
                 '2nd map second half - handicap heroic +2.5': {'1.35': 'ggbet'},
                 '2nd map second half - handicap heroic -1.5': {'2.38': 'ggbet'},
                 '2nd map second half - handicap heroic -3.5': {'3.79': 'ggbet'},
                 '2nd map second half - handicap og +1.5': {'1.54': 'ggbet'},
                 '2nd map second half - handicap og +3.5': {'1.24': 'ggbet'},
                 '2nd map second half - handicap og -0.5': {'2.05': 'ggbet'},
                 '2nd map second half - handicap og -2.5': {'3.04': 'ggbet'},
                 'correct score 0-2': {'3.71': 'ggbet'},
                 'correct score 1-2': {'3.8': 'ggbet'},
                 'correct score 2-0': {'3.11': 'ggbet'},
                 'correct score 2-1': {'3.5': 'ggbet'},
                 'handicap heroic +0.5': {'1.72': 'ggbet'},
                 'handicap heroic +3.5': {'1.55': 'ggbet'},
                 'handicap heroic +5.5': {'1.43': 'ggbet'},
                 'handicap heroic +7.5': {'1.3': 'ggbet'},
                 'handicap heroic -10.5': {'4.23': 'ggbet'},
                 'handicap heroic -2.5': {'1.93': 'ggbet'},
                 'handicap heroic -4.5': {'2.16': 'ggbet'},
                 'handicap heroic -6.5': {'2.54': 'ggbet'},
                 'handicap heroic -8.5': {'3.2': 'ggbet'},
                 'handicap og +10.5': {'1.2': 'ggbet'},
                 'handicap og +2.5': {'1.81': 'ggbet'},
                 'handicap og +4.5': {'1.65': 'ggbet'},
                 'handicap og +6.5': {'1.48': 'ggbet'},
                 'handicap og +8.5': {'1.32': 'ggbet'},
                 'handicap og -0.5': {'2.05': 'ggbet'},
                 'handicap og -3.5': {'2.35': 'ggbet'},
                 'handicap og -5.5': {'2.7': 'ggbet'},
                 'handicap og -7.5': {'3.32': 'ggbet'},
                 'heroic handicap +1.5 maps': {'1.25': 'ggbet'},
                 'heroic handicap -1.5 maps': {'3.09': 'ggbet'},
                 'heroic total over 27.5': {'1.21': 'ggbet'},
                 'heroic total over 32.5': {'1.82': 'ggbet'},
                 'heroic total over 36.5': {'2.25': 'ggbet'},
                 'heroic total over 40.5': {'3.14': 'ggbet'},
                 'heroic total under 27.5': {'4.11': 'ggbet'},
                 'heroic total under 32.5': {'1.92': 'ggbet'},
                 'heroic total under 36.5': {'1.6': 'ggbet'},
                 'heroic total under 40.5': {'1.33': 'ggbet'},
                 'heroic will win': {'1.76': 'ggbet'},
                 'odd/even maps even': {'1.81': 'ggbet'},
                 'odd/even maps odd': {'1.93': 'ggbet'},
                 'og handicap +1.5 maps': {'1.34': 'ggbet'},
                 'og handicap -1.5 maps': {'3.7': 'ggbet'},
                 'og total over 24.5': {'1.21': 'ggbet'},
                 'og total over 32.5': {'1.87': 'ggbet'},
                 'og total over 36.5': {'2.33': 'ggbet'},
                 'og total over 40.5': {'3.32': 'ggbet'},
                 'og total under 24.5': {'4.11': 'ggbet'},
                 'og total under 32.5': {'1.87': 'ggbet'},
                 'og total under 36.5': {'1.56': 'ggbet'},
                 'og total under 40.5': {'1.3': 'ggbet'},
                 'og will win': {'2.01': 'ggbet'},
                 'total maps over 2.5': {'1.93': 'ggbet'},
                 'total maps under 2.5': {'1.81': 'ggbet'},
                 'total over 52.5': {'1.22': 'ggbet'},
                 'total over 54.5': {'1.34': 'ggbet'},
                 'total over 56.5': {'1.47': 'ggbet'},
                 'total over 58.5': {'1.59': 'ggbet'},
                 'total over 62.5': {'1.73': 'ggbet'},
                 'total over 68.5': {'1.9': 'ggbet'},
                 'total over 73.5': {'2.16': 'ggbet'},
                 'total over 76.5': {'2.51': 'ggbet'},
                 'total over 78.5': {'2.85': 'ggbet'},
                 'total over 80.5': {'3.39': 'ggbet'},
                 'total over 82.5': {'4.11': 'ggbet'},
                 'total under 52.5': {'3.99': 'ggbet'},
                 ...
                 'total under 56.5': {'2.57': 'ggbet'},
                 'total under 58.5': {'2.27': 'ggbet'},
                 'total under 62.5': {'2.03': 'ggbet'},
                 'total under 68.5': {'1.84': 'ggbet'},
                 'total under 73.5': {'1.65': 'ggbet'},
                 'total under 76.5': {'1.49': 'ggbet'},
                 'total under 78.5': {'1.39': 'ggbet'},
                 'total under 80.5': {'1.29': 'ggbet'},
                 'total under 82.5': {'1.21': 'ggbet'}},
 'hyper - rbg': {'1-st map: hyper will win': {'2.7': 'ggbet'},
                 '1-st map: rbg will win': {'1.43': 'ggbet'},
                 '2-nd map: hyper will win': {'2.7': 'ggbet'},
                 '2-nd map: rbg will win': {'1.43': 'ggbet'},
                 'hyper will win': {'3.14': 'ggbet'},
                 'rbg will win': {'1.34': 'ggbet'}},
 'invictus gaming - lucid dream': {'1-st map: handicap invictus gaming -2.5': {'1.68': 'ggbet'},
                                   '1-st map: handicap invictus gaming -3.5': {'1.86': 'ggbet'},
                                   '1-st map: handicap invictus gaming -4.5': {'2.11': 'ggbet'},
                                   '1-st map: handicap lucid dream +2.5': {'2.11': 'ggbet'},
                                   '1-st map: handicap lucid dream +3.5': {'1.88': 'ggbet'},
                                   '1-st map: handicap lucid dream +4.5': {'1.68': 'ggbet'},
                                   '1-st map: invictus gaming will win': {'1.41': 'ggbet'},
                                   '1-st map: invictus gaming will win round 1': {'1.8': 'ggbet'},
                                   '1-st map: lucid dream will win': {'2.77': 'ggbet'},
                                   '1-st map: lucid dream will win round 1': {'1.94': 'ggbet'},
                                   '1-st map: total over 26.5': {'1.89': 'ggbet'},
                                   '1-st map: total under 26.5': {'1.85': 'ggbet'},
                                   '2-nd map: handicap invictus gaming -2.5': {'1.67': 'ggbet'},
                                   '2-nd map: handicap invictus gaming -3.5': {'1.85': 'ggbet'},
                                   '2-nd map: handicap invictus gaming -4.5': {'2.09': 'ggbet'},
                                   '2-nd map: handicap lucid dream +2.5': {'2.12': 'ggbet'},
                                   '2-nd map: handicap lucid dream +3.5': {'1.89': 'ggbet'},
                                   '2-nd map: handicap lucid dream +4.5': {'1.69': 'ggbet'},
                                   '2-nd map: invictus gaming will win': {'1.4': 'ggbet'},
                                   '2-nd map: invictus gaming will win round 1': {'1.79': 'ggbet'},
                                   '2-nd map: lucid dream will win': {'2.81': 'ggbet'},
                                   '2-nd map: lucid dream will win round 1': {'1.96': 'ggbet'},
                                   '2-nd map: total over 25.5': {'1.61': 'ggbet'},
                                   '2-nd map: total over 26.5': {'1.9': 'ggbet'},
                                   '2-nd map: total under 25.5': {'2.23': 'ggbet'},
                                   '2-nd map: total under 26.5': {'1.84': 'ggbet'},
                                   'correct score 0-2': {'5.96': 'ggbet'},
                                   'correct score 1-2': {'5.65': 'ggbet'},
                                   'correct score 2-0': {'1.95': 'ggbet'},
                                   'correct score 2-1': {'3.5': 'ggbet'},
                                   'invictus gaming handicap +1.5 maps': {'1.11': 'ggbet'},
                                   'invictus gaming handicap -1.5 maps': {'1.94': 'ggbet'},
                                   'invictus gaming will win': {'1.32': 'ggbet'},
                                   'lucid dream handicap +1.5 maps': {'1.8': 'ggbet'},
                                   'lucid dream handicap -1.5 maps': {'5.91': 'ggbet'},
                                   'lucid dream will win': {'3.25': 'ggbet'},
                                   'odd/even maps even': {'1.56': 'ggbet'},
                                   'odd/even maps odd': {'2.33': 'ggbet'},
                                   'total maps over 2.5': {'2.33': 'ggbet'},
                                   'total maps under 2.5': {'1.56': 'ggbet'}},
 'invictus gaming - mazaalai': {'1-st map: handicap invictus gaming -3.5': {'1.66': 'ggbet'},
                                '1-st map: handicap invictus gaming -4.5': {'1.86': 'ggbet'},
                                '1-st map: handicap invictus gaming -5.5': {'2.14': 'ggbet'},
                                '1-st map: handicap mazaalai +3.5': {'2.14': 'ggbet'},
                                '1-st map: handicap mazaalai +4.5': {'1.88': 'ggbet'},
                                '1-st map: handicap mazaalai +5.5': {'1.66': 'ggbet'},
                                '1-st map: invictus gaming will win': {'1.3': 'ggbet'},
                                '1-st map: invictus gaming will win round 1': {'1.77': 'ggbet'},
                                '1-st map: mazaalai will win': {'3.32': 'ggbet'},
                                '1-st map: mazaalai will win round 1': {'1.98': 'ggbet'},
                                ...
                                '2-nd map: handicap invictus gaming -3.5': {'1.65': 'ggbet'},
                                '2-nd map: handicap invictus gaming -4.5': {'1.84': 'ggbet'},
                                '2-nd map: handicap invictus gaming -5.5': {'2.11': 'ggbet'},
                                '2-nd map: handicap mazaalai +3.5': {'2.16': 'ggbet'},
                                '2-nd map: handicap mazaalai +4.5': {'1.9': 'ggbet'},
                                '2-nd map: handicap mazaalai +5.5': {'1.68': 'ggbet'},
                                '2-nd map: invictus gaming will win': {'1.29': 'ggbet'},
                                '2-nd map: invictus gaming will win round 1': {'1.76': 'ggbet'},
                                '2-nd map: mazaalai will win': {'3.39': 'ggbet'},
                                '2-nd map: mazaalai will win round 1': {'1.99': 'ggbet'},
                                ...
                                'correct score 2-1': {'3.63': 'ggbet'},
                                'invictus gaming handicap +1.5 maps': {'1.06': 'ggbet'},
                                'invictus gaming handicap -1.5 maps': {'1.68': 'ggbet'},
                                'invictus gaming will win': {'1.2': 'ggbet'},
                                'mazaalai handicap +1.5 maps': {'2.11': 'ggbet'},
                                'mazaalai handicap -1.5 maps': {'7.9': 'ggbet'},
 ...
 'kinship - thunder logic': {'1-st map: kinship will win': {'1.57': 'ggbet'},
                             '1-st map: thunder logic will win': {'2.31': 'ggbet'},
                             '2-nd map: kinship will win': {'1.57': 'ggbet'},
                             '2-nd map: thunder logic will win': {'2.31': 'ggbet'},
                             'kinship will win': {'1.5': 'ggbet'},
                             'thunder logic will win': {'2.51': 'ggbet'}},
 'kova - veto': {'1-st map: kova will win': {'1.4': 'ggbet'},
                 '1-st map: veto will win': {'2.81': 'ggbet'},
                 '2-nd map: kova will win': {'1.4': 'ggbet'},
                 '2-nd map: veto will win': {'2.81': 'ggbet'},
                 'kova will win': {'1.31': 'ggbet'},
                 'veto will win': {'3.32': 'ggbet'}},
 'lucid dream - tiger': {'1-st map: handicap lucid dream +2.5': {'2.02': 'ggbet'},
                         '1-st map: handicap lucid dream +3.5': {'1.8': 'ggbet'},
                         '1-st map: handicap lucid dream +4.5': {'1.62': 'ggbet'},
                         '1-st map: handicap tiger -2.5': {'1.74': 'ggbet'},
                         '1-st map: handicap tiger -3.5': {'1.94': 'ggbet'},
                         '1-st map: handicap tiger -4.5': {'2.21': 'ggbet'},
                         '1-st map: lucid dream will win': {'2.6': 'ggbet'},
                         '1-st map: lucid dream will win round 1': {'1.94': 'ggbet'},
                         '1-st map: tiger will win': {'1.46': 'ggbet'},
                         '1-st map: tiger will win round 1': {'1.8': 'ggbet'},
                         '1-st map: total over 26.5': {'1.86': 'ggbet'},
                         '1-st map: total under 26.5': {'1.88': 'ggbet'},
                         '2-nd map: handicap lucid dream +2.5': {'2.03': 'ggbet'},
                         '2-nd map: handicap lucid dream +3.5': {'1.81': 'ggbet'},
                         '2-nd map: handicap lucid dream +4.5': {'1.63': 'ggbet'},
                         '2-nd map: handicap tiger -2.5': {'1.73': 'ggbet'},
                         '2-nd map: handicap tiger -3.5': {'1.93': 'ggbet'},
                         '2-nd map: handicap tiger -4.5': {'2.19': 'ggbet'},
                         '2-nd map: lucid dream will win': {'2.6': 'ggbet'},
                         '2-nd map: lucid dream will win round 1': {'1.93': 'ggbet'},
                         '2-nd map: tiger will win': {'1.46': 'ggbet'},
                         '2-nd map: tiger will win round 1': {'1.81': 'ggbet'},
                         '2-nd map: total over 26.5': {'1.87': 'ggbet'},
                         '2-nd map: total under 26.5': {'1.87': 'ggbet'},
                         'correct score 0-2': {'2.05': 'ggbet'},
                         'correct score 1-2': {'3.5': 'ggbet'},
                         'correct score 2-0': {'5.5': 'ggbet'},
                         'correct score 2-1': {'5.33': 'ggbet'},
                         'lucid dream handicap +1.5 maps': {'1.72': 'ggbet'},
                         'lucid dream handicap -1.5 maps': {'5.4': 'ggbet'},
                         'lucid dream will win': {'3.03': 'ggbet'},
                         'odd/even maps even': {'1.59': 'ggbet'},
                         'odd/even maps odd': {'2.27': 'ggbet'},
                         'tiger handicap +1.5 maps': {'1.13': 'ggbet'},
                         'tiger handicap -1.5 maps': {'2.05': 'ggbet'},
                         'tiger will win': {'1.36': 'ggbet'},
                         'total maps over 2.5': {'2.27': 'ggbet'},
                         'total maps under 2.5': {'1.59': 'ggbet'}},
 'mazaalai - tyloo': {'1-st map: handicap mazaalai +4.5': {'2.17': 'ggbet'},
                      '1-st map: handicap mazaalai +5.5': {'1.88': 'ggbet'},
                      '1-st map: handicap mazaalai +6.5': {'1.65': 'ggbet'},
                      '1-st map: handicap tyloo -4.5': {'1.64': 'ggbet'},
                      '1-st map: handicap tyloo -5.5': {'1.86': 'ggbet'},
                      '1-st map: handicap tyloo -6.5': {'2.16': 'ggbet'},
                      '1-st map: mazaalai will win': {'4.23': 'ggbet'},
                      '1-st map: mazaalai will win round 1': {'2.02': 'ggbet'},
                      '1-st map: total over 25.5': {'1.8': 'ggbet'},
                      '1-st map: total over 26.5': {'2.16': 'ggbet'},
                      '1-st map: total under 25.5': {'1.94': 'ggbet'},
                      '1-st map: total under 26.5': {'1.65': 'ggbet'},
                      '1-st map: tyloo will win': {'1.2': 'ggbet'},
                      '1-st map: tyloo will win round 1': {'1.74': 'ggbet'},
                      '2-nd map: handicap mazaalai +4.5': {'2.19': 'ggbet'},
                      '2-nd map: handicap mazaalai +5.5': {'1.9': 'ggbet'},
                      '2-nd map: handicap mazaalai +6.5': {'1.66': 'ggbet'},
                      '2-nd map: handicap tyloo -4.5': {'1.63': 'ggbet'},
                      '2-nd map: handicap tyloo -5.5': {'1.84': 'ggbet'},
                      '2-nd map: handicap tyloo -6.5': {'2.14': 'ggbet'},
                      '2-nd map: mazaalai will win': {'4.23': 'ggbet'},
                      '2-nd map: mazaalai will win round 1': {'2.02': 'ggbet'},
                      '2-nd map: total over 25.5': {'1.82': 'ggbet'},
                      '2-nd map: total over 26.5': {'2.17': 'ggbet'},
                      '2-nd map: total under 25.5': {'1.92': 'ggbet'},
                      '2-nd map: total under 26.5': {'1.64': 'ggbet'},
                      '2-nd map: tyloo will win': {'1.2': 'ggbet'},
                      '2-nd map: tyloo will win round 1': {'1.74': 'ggbet'},
                      'correct score 0-2': {'1.45': 'ggbet'},
                      'correct score 1-2': {'3.98': 'ggbet'},
                      'correct score 2-0': {'10.13': 'ggbet'},
                      'correct score 2-1': {'8.86': 'ggbet'},
                      'mazaalai handicap +1.5 maps': {'2.63': 'ggbet'},
                      'mazaalai handicap -1.5 maps': {'10.09': 'ggbet'},
                      'mazaalai will win': {'6.09': 'ggbet'},
                      'odd/even maps even': {'1.35': 'ggbet'},
                      'odd/even maps odd': {'3.04': 'ggbet'},
                      'total maps over 2.5': {'3.04': 'ggbet'},
                      'total maps under 2.5': {'1.35': 'ggbet'},
                      'tyloo handicap +1.5 maps': {'1.03': 'ggbet'},
                      'tyloo handicap -1.5 maps': {'1.45': 'ggbet'},
                      'tyloo will win': {'1.11': 'ggbet'}},
 'mistaken - zigma': {'1-st map: mistaken will win': {'3.79': 'ggbet'},
                      '1-st map: zigma will win': {'1.24': 'ggbet'},
                      '2-nd map: mistaken will win': {'3.79': 'ggbet'},
                      '2-nd map: zigma will win': {'1.24': 'ggbet'},
                      'mistaken will win': {'5.12': 'ggbet'},
                      'zigma will win': {'1.15': 'ggbet'}},
 'nemiga - sprout': {'1-st map: handicap nemiga +1.5': {'2.14': 'ggbet'},
                     '1-st map: handicap nemiga +2.5': {'1.91': 'ggbet'},
                     '1-st map: handicap nemiga +3.5': {'1.72': 'ggbet'},
                     '1-st map: handicap nemiga +4.5': {'1.56': 'ggbet'},
                     '1-st map: handicap nemiga +5.5': {'1.42': 'ggbet'},
                     '1-st map: handicap nemiga +6.5': {'1.31': 'ggbet'},
                     '1-st map: handicap nemiga +7.5': {'1.22': 'ggbet'},
                     '1-st map: handicap nemiga -1.5': {'2.7': 'ggbet'},
                     '1-st map: handicap nemiga -2.5': {'3.09': 'ggbet'},
                     '1-st map: handicap nemiga -3.5': {'3.62': 'ggbet'},
                     '1-st map: handicap sprout +1.5': {'1.43': 'ggbet'},
                     '1-st map: handicap sprout +2.5': {'1.34': 'ggbet'},
                     '1-st map: handicap sprout +3.5': {'1.26': 'ggbet'},
                     '1-st map: handicap sprout -1.5': {'1.66': 'ggbet'},
                     '1-st map: handicap sprout -2.5': {'1.83': 'ggbet'},
                     '1-st map: handicap sprout -3.5': {'2.05': 'ggbet'},
                     '1-st map: handicap sprout -4.5': {'2.33': 'ggbet'},
                     '1-st map: handicap sprout -5.5': {'2.73': 'ggbet'},
                     '1-st map: handicap sprout -6.5': {'3.26': 'ggbet'},
                     '1-st map: handicap sprout -7.5': {'3.99': 'ggbet'},
                     '1-st map: nemiga will win': {'2.43': 'ggbet'},
                     '1-st map: nemiga will win round 1': {'1.92': 'ggbet'},
                     '1-st map: sprout will win': {'1.52': 'ggbet'},
                     ...
                     '2-nd map: handicap nemiga +1.5': {'2.16': 'ggbet'},
                     '2-nd map: handicap nemiga +2.5': {'1.92': 'ggbet'},
                     '2-nd map: handicap nemiga +3.5': {'1.73': 'ggbet'},
                     '2-nd map: handicap nemiga +4.5': {'1.57': 'ggbet'},
                     '2-nd map: handicap nemiga +5.5': {'1.43': 'ggbet'},
                     '2-nd map: handicap nemiga +6.5': {'1.32': 'ggbet'},
                     '2-nd map: handicap nemiga +7.5': {'1.23': 'ggbet'},
                     '2-nd map: handicap nemiga -1.5': {'2.73': 'ggbet'},
                     '2-nd map: handicap nemiga -2.5': {'3.09': 'ggbet'},
                     '2-nd map: handicap nemiga -3.5': {'3.62': 'ggbet'},
                     '2-nd map: handicap sprout +1.5': {'1.42': 'ggbet'},
                     '2-nd map: handicap sprout +2.5': {'1.34': 'ggbet'},
                     '2-nd map: handicap sprout +3.5': {'1.26': 'ggbet'},
                     '2-nd map: handicap sprout -1.5': {'1.65': 'ggbet'},
                     '2-nd map: handicap sprout -2.5': {'1.82': 'ggbet'},
                     '2-nd map: handicap sprout -3.5': {'2.03': 'ggbet'},
                     '2-nd map: handicap sprout -4.5': {'2.31': 'ggbet'},
                     '2-nd map: handicap sprout -5.5': {'2.7': 'ggbet'},
                     '2-nd map: handicap sprout -6.5': {'3.2': 'ggbet'},
                     '2-nd map: handicap sprout -7.5': {'3.89': 'ggbet'},
                     '2-nd map: nemiga will win': {'2.45': 'ggbet'},
                     '2-nd map: nemiga will win round 1': {'1.93': 'ggbet'},
                     '2-nd map: sprout will win': {'1.51': 'ggbet'},
                     ...
                     'correct score 0-2': {'2.22': 'ggbet'},
                     'correct score 1-2': {'3.51': 'ggbet'},
                     'correct score 2-0': {'4.88': 'ggbet'},
                     'correct score 2-1': {'4.93': 'ggbet'},
                     'nemiga handicap +1.5 maps': {'1.61': 'ggbet'},
                     'nemiga handicap -1.5 maps': {'4.81': 'ggbet'},
                     'nemiga will win': {'2.7': 'ggbet'},
                     'odd/even maps even': {'1.62': 'ggbet'},
                     'odd/even maps odd': {'2.21': 'ggbet'},
                     'sprout handicap +1.5 maps': {'1.16': 'ggbet'},
                     'sprout handicap -1.5 maps': {'2.23': 'ggbet'},
                     'sprout will win': {'1.44': 'ggbet'},
                     'total maps over 2.5': {'2.21': 'ggbet'},
                     'total maps under 2.5': {'1.62': 'ggbet'}},
 'northern forces - tnt': {'1-st map: northern forces will win': {'1.66': 'ggbet'},
                           '1-st map: tnt will win': {'2.14': 'ggbet'},
                           '2-nd map: northern forces will win': {'1.66': 'ggbet'},
                           '2-nd map: tnt will win': {'2.14': 'ggbet'},
                           'northern forces will win': {'1.61': 'ggbet'},
                           'tnt will win': {'2.25': 'ggbet'}},
 'reckoning - wolf': {'1-st map: reckoning will win': {'1.42': 'ggbet'},
                      '1-st map: wolf will win': {'2.73': 'ggbet'},
                      'reckoning will win': {'1.43': 'ggbet'},
                      'wolf will win': {'2.73': 'ggbet'}},
 'third impact - valkyrie': {'1-st map: third impact will win': {'1.53': 'ggbet'},
                             '1-st map: valkyrie will win': {'2.4': 'ggbet'},
                             '2-nd map: third impact will win': {'1.53': 'ggbet'},
                             '2-nd map: valkyrie will win': {'2.4': 'ggbet'},
                             'third impact will win': {'1.44': 'ggbet'},
                             'valkyrie will win': {'2.7': 'ggbet'}}}
=======
bets = {
    'adaptation - blink': {
